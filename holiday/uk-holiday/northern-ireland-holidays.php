<?php 
// Northern Ireland Holidays 2026 - Page specific head content
$page_title = "Northern Ireland Holidays 2026 - Complete Calendar & Bank Holidays | 25+ Years Experience";
$page_description = "Complete Northern Ireland Holiday Calendar 2026 with all bank holidays, cultural events, and observances. Professional holiday planning guide with 25+ years of expertise. Plan your year with our comprehensive Northern Ireland holiday directory.";
$page_keywords = "Northern Ireland holidays 2026, Northern Ireland bank holidays, UK holidays, Northern Ireland festivals, Northern Ireland calendar, holidays Northern Ireland, festival dates 2026, 25 years experience";
...
<nav class="bg-white shadow-sm border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center space-x-2 py-3 text-sm">
            ...
            <i class="fas fa-chevron-right text-gray-400"></i>
            <span class="text-gray-600 font-medium">Northern Ireland Holidays 2026</span>
        </div>
    </div>
</nav>

<?php
// Northern Ireland Holidays 2026 Data
$holidays_2026 = array (
  '2026-01-01' => 
  array (
    'name' => 'New Year\'s Day',
    ...
    <div class="container mx-auto px-4 py-6 relative z-10">
        <div class="flex items-center justify-between">
            ...
            <span class="relative text-blue-600 font-bold text-xs">NI</span>
                        ...
                        <span>Northern Ireland Holidays 2026</span>
                    </div></h1>
