...
$page_keywords = "Wales holidays 2026, Wales bank holidays, UK holidays, Wales festivals, Wales calendar, holidays Wales, festival dates 2026, 25 years experience";
...
<style>
:root {
    --state-primary: #00B04F;
    --state-secondary: #009442;
}
...
<nav class="bg-white shadow-sm border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center space-x-2 py-3 text-sm">
            ...
            <i class="fas fa-chevron-right text-gray-400"></i>
            <span class="text-gray-600 font-medium">Wales Holidays 2026</span>
        </div>
    </div>
</nav>

<?php
// Wales Holidays 2026 Data
$holidays_2026 = array (
  '2026-01-01' => 
  array (
    'name' => 'New Year\'s Day',
