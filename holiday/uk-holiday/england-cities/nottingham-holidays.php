<?php 
// Nottingham Holidays 2026 - Page specific head content
...
<nav class="bg-white shadow-sm border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center space-x-2 py-3 text-sm">
            ...
            <i class="fas fa-chevron-right text-gray-400"></i>
            <span class="text-gray-600 font-medium">Nottingham Holidays 2026</span>
        </div>
    </div>
</nav>

<?php
// Nottingham Holidays 2026 Data
$holidays_2026 = array (
  '2026-01-01' => 
  array (
    'name' => 'New Year\'s Day',
  ...
  '2026-10-19' => 
  array (
    'name' => 'Robin Hood Festival',
    'type' => 'Historical Festival',
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <div class="flex items-center space-x-3 mb-2">
                        ...
                        <i class="fa-solid fa-bow-arrow text-2xl text-green-700"></i>
                    </div>
                        <h1 class="text-4xl font-bold">Nottingham Holidays 2026</h1>
                    </div>
                    <p class="text-lg opacity-90">Nottinghamshire • Bank Holidays • Local Events • Festivals</p>
                    <p class="text-sm opacity-75">Patron Saint: St. Peter • Sheriff of Nottingham</p>
                </div>
            </div>
    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-center space-x-8 text-sm text-gray-700">
            ...
            <div class="flex items-center space-x-2">
                ...
                <span>Sheriff of Nottingham</span>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="bg-gradient-to-br from-city-primary to-city-secondary text-white rounded-lg shadow-lg p-6">
                ...
                <div class="space-y-2 text-sm">
                    <div class="flex justify-between">
                        <span>County:</span>
                        <span class="font-semibold">Nottinghamshire</span>
                    </div>
                    <div class="flex justify-between">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-semibold">Sheriff of Nottingham</span>
                    </div>
                </div>
            </div>
        </div>
