<?php 
// Cambridge Holidays 2026 - Page specific head content
...
<title>Cambridge Holidays 2026 | Complete Calendar | Local Events | Bank Holidays</title>
<meta name="description" content="Complete Cambridge Holiday Calendar 2026. Find all bank holidays, local events, festivals, and observances. Plan your year with our comprehensive Cambridge holiday guide.">
<meta name="keywords" content="Cambridge holidays 2026, Cambridge events, Cambridge festivals, England holidays, Cambridge calendar">
<style>
:root {
    --city-primary: #003366;
...
<nav class="bg-white shadow-sm border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center space-x-2 py-3 text-sm">
            ...
            <i class="fas fa-chevron-right text-gray-400"></i>
            <span class="text-gray-600 font-medium">Cambridge Holidays 2026</span>
        </div>
    </div>
</nav>

<?php
// Cambridge Holidays 2026 Data
$holidays_2026 = array (
  '2026-01-01' => 
  array (
    'name' => 'New Year\'s Day',
  ...
  array (
    'name' => 'May Bumps',
    'type' => 'Rowing Competition',
    'icon' => 'fa-solid fa-oar',
  ),
  '2026-05-26' => 
  array (
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <div class="flex items-center space-x-3 mb-2">
                        ...
                        <h1 class="text-4xl font-bold">Cambridge Holidays 2026</h1>
                    </div>
                    <p class="text-lg opacity-90">Cambridgeshire • Bank Holidays • Local Events • Festivals</p>
                    <p class="text-sm opacity-75">Patron Saint: St. Benet • Mayor of Cambridge</p>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-city-primary to-city-secondary text-white rounded-lg shadow-lg p-6">
                ...
                <div class="space-y-2 text-sm">
                    <div class="flex justify-between">
                        <span>County:</span>
                        <span class="font-semibold">Cambridgeshire</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Patron Saint:</span>
                        <span class="font-semibold">St. Benet</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Leadership:</span>
                        <span class="font-semibold">Mayor of Cambridge</span>
                    </div>
                </div>
            </div>
        </div>
