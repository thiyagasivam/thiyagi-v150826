    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-center space-x-8 text-sm text-gray-700">
            ...
            <div class="flex items-center space-x-2">
                ...
                <span>Lord Mayor of London</span>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="bg-gradient-to-br from-city-primary to-city-secondary text-white rounded-lg shadow-lg p-6">
                ...
                <div class="space-y-2 text-sm">
                    <div class="flex justify-between">
                        <span>County:</span>
                        <span class="font-semibold">Greater London</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Patron Saint:</span>
                        <span class="font-semibold">St. Paul</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Leadership:</span>
                        <span class="font-semibold">Lord Mayor of London</span>
                    </div>
                </div>
            </div>
        </div>
...
<div class="bg-white rounded-lg shadow-lg mx-4 mb-8" style="background-color: #ffffff !important; color: #374151 !important;">
    <div class="p-8">
        <h2 class="text-3xl font-bold text-center mb-8 text-gray-800" style="color: #111827 !important;">
            <i class="fas fa-lightbulb text-yellow-500 mr-3"></i>
            Holiday Planning Tips
        </h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-lg" style="background-color: #f0f9ff !important; color: #374151 !important;">
                <h3 class="text-xl font-bold mb-4 text-blue-800 flex items-center" style="color: #1e40af !important;">
                    <i class="fas fa-calendar-check mr-2"></i>
                    Plan Ahead
                </h3>
                <ul class="text-gray-700 space-y-2 text-sm" style="color: #4b5563 !important;">
            ...
            <div class="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-lg" style="background-color: #f0fdf4 !important; color: #374151 !important;">
                <h3 class="text-xl font-bold mb-4 text-green-800 flex items-center" style="color: #166534 !important;">
