<?php 
// Bath Holidays 2026 - Page specific head content
...
<title>Bath Holidays 2026 | Complete Calendar | Local Events | Bank Holidays</title>
<meta name="description" content="Complete Bath Holiday Calendar 2026. Find all bank holidays, local events, festivals, and observances. Plan your year with our comprehensive Bath holiday guide.">
<meta name="keywords" content="Bath holidays 2026, Bath events, Bath festivals, Somerset holidays, England holidays, Bath calendar">

<style>
:root {
    --city-primary: #FFD700;
    --city-secondary: #B8860B;
}
...
<nav class="bg-white shadow-sm border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center space-x-2 py-3 text-sm">
            ...
            <i class="fas fa-chevron-right text-gray-400"></i>
            <span class="text-gray-600 font-medium">Bath Holidays 2026</span>
        </div>
    </div>
</nav>

<?php
// Bath Holidays 2026 Data
$holidays_2026 = array (
  '2026-01-01' => 
  array (
    'name' => 'New Year\'s Day',
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <div class="flex items-center space-x-3 mb-2">
                        ...
                        <i class="fa-solid fa-church text-2xl text-yellow-600"></i>
                    </div>
                        <h1 class="text-4xl font-bold">Bath Holidays 2026</h1>
                    </div>
                    <p class="text-lg opacity-90">Somerset • Bank Holidays • Local Events • Festivals</p>
                    <p class="text-sm opacity-75">Patron Saint: St. Peter • Mayor of Bath</p>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-city-primary to-city-secondary text-white rounded-lg shadow-lg p-6">
                ...
                <div class="space-y-2 text-sm">
                    <div class="flex justify-between">
                        <span>County:</span>
                        <span class="font-semibold">Somerset</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Patron Saint:</span>
                        <span class="font-semibold">St. Peter</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Leadership:</span>
                        <span class="font-semibold">Mayor of Bath</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-lg">
                ...
                <ul class="text-gray-700 space-y-2 text-sm">
                    <li><i class="fas fa-check text-green-500 mr-2"></i>Book Bath accommodations early for festival periods</li>
                    <li><i class="fas fa-check text-green-500 mr-2"></i>Check Bath Festival and local event schedules</li>
                    <li><i class="fas fa-check text-green-500 mr-2"></i>Consider school holidays when visiting attractions</li>
                    <li><i class="fas fa-check text-green-500 mr-2"></i>Monitor Bath Spa train services during holidays</li>
                </ul>
            </div>
            <div class="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-lg">
                ...
                <ul class="text-gray-700 space-y-2 text-sm">
                    <li><i class="fas fa-check text-green-500 mr-2"></i>Book Roman Baths tickets online in advance</li>
                    <li><i class="fas fa-check text-green-500 mr-2"></i>Look for Bath tourism package deals</li>
                    <li><i class="fas fa-check text-green-500 mr-2"></i>Visit during off-peak times for better rates</li>
                    <li><i class="fas fa-check text-green-500 mr-2"></i>Use Bath's Park and Ride services</li>
                </ul>
            </div>
            <div class="bg-gradient-to-br from-city-primary to-city-secondary text-white p-6 rounded-lg">
                <h3 class="text-xl font-bold mb-4 flex items-center">
                    <i class="fas fa-map-marked-alt mr-2"></i>
                    Bath Events
                </h3>
                <ul class="space-y-2 text-sm">
                    <li><i class="fas fa-check mr-2"></i>Bath Festival (Music & Literature)</li>
                    <li><i class="fas fa-check mr-2"></i>Bath Christmas Market</li>
                    <li><i class="fas fa-check mr-2"></i>Jane Austen Festival</li>
                    <li><i class="fas fa-check mr-2"></i>Bath Half Marathon</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="bg-gradient-to-r from-city-primary to-city-secondary text-white rounded-lg shadow-lg mx-4 mb-8">
    <div class="p-8">
            ...
            <div>
                ...
                <ul class="space-y-3 text-gray-700">
                    <li class="flex items-start">
                        ...
                        <span>Bath banks are closed on all UK bank holidays</span>
                    </li>
                    <li class="flex items-start">
            ...
            <div>
                ...
                <ul class="space-y-3 text-gray-700">
                    ...
                    <li class="flex items-start">
                        ...
                        <span>Locate ATMs near Bath city center and attractions</span>
                    </li>
                    <li class="flex items-start">
                    ...
                    <li class="flex items-start">
                        ...
                        <span>Bath Post Office offers some banking services</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div class="space-y-4">
                <div class="bg-white p-6 rounded-lg shadow">
                    <h3 class="font-bold text-lg mb-2 text-gray-800">Are Bath attractions open on bank holidays?</h3>
                    <p class="text-gray-600">Most Bath attractions like the Roman Baths, Bath Abbey, and Royal Crescent remain open on bank holidays, though hours may vary. Check individual attraction websites for holiday schedules.</p>
                </div>
                <div class="bg-white p-6 rounded-lg shadow">
                    <h3 class="font-bold text-lg mb-2 text-gray-800">How do I get to Bath on bank holidays?</h3>
                    <p class="text-gray-600">Trains run on Sunday schedules during bank holidays. Bath Spa station has regular services from London and other major cities. Book in advance for better prices.</p>
                </div>
                <div class="bg-white p-6 rounded-lg shadow">
                    <h3 class="font-bold text-lg mb-2 text-gray-800">What festivals happen in Bath during holidays?</h3>
                    <p class="text-gray-600">Bath hosts various festivals throughout the year including the Bath Festival (May), Jane Austen Festival (September), and Bath Christmas Market (December).</p>
                </div>
            </div>
            <div class="space-y-4">
                <div class="bg-white p-6 rounded-lg shadow">
                    <h3 class="font-bold text-lg mb-2 text-gray-800">Where can I park in Bath during holidays?</h3>
                    <p class="text-gray-600">Use Bath's Park and Ride services during busy holiday periods. City center parking fills up quickly. Consider staying outside the city and using public transport.</p>
                </div>
                <div class="bg-white p-6 rounded-lg shadow">
                    <h3 class="font-bold text-lg mb-2 text-gray-800">Are Bath restaurants open on bank holidays?</h3>
                    <p class="text-gray-600">Many Bath restaurants remain open during bank holidays, especially in the tourist areas. However, some may have limited hours or require reservations due to increased demand.</p>
                </div>
                <div class="bg-white p-6 rounded-lg shadow">
                    <h3 class="font-bold text-lg mb-2 text-gray-800">What's the best time to visit Bath attractions?</h3>
                    <p class="text-gray-600">Early morning or late afternoon visits are best during bank holidays to avoid crowds. Consider purchasing skip-the-line tickets for popular attractions like the Roman Baths.</p>
                </div>
            </div>
        </div>
    </div>
