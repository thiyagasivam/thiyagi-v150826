<?php 
// Manchester Holidays 2026 - Page specific head content
...
<title>Manchester Holidays 2026 | Complete Calendar | Local Events | Bank Holidays</title>
<meta name="description" content="Complete Manchester Holiday Calendar 2026. Find all bank holidays, local events, festivals, and observances. Plan your year with our comprehensive Manchester holiday guide.">
<meta name="keywords" content="Manchester holidays 2026, Manchester events, Manchester festivals, England holidays, Manchester calendar">
<style>
:root {
    --city-primary: #FFD700;
...
<nav class="bg-white shadow-sm border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center space-x-2 py-3 text-sm">
            ...
            <i class="fas fa-chevron-right text-gray-400"></i>
            <span class="text-gray-600 font-medium">Manchester Holidays 2026</span>
        </div>
    </div>
</nav>

<?php
// Manchester Holidays 2026 Data
$holidays_2026 = array (
  '2026-01-01' => 
  array (
    'name' => 'New Year\'s Day',
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <div class="flex items-center space-x-3 mb-2">
                        ...
                        <i class="fa-solid fa-futbol text-2xl text-sky-600"></i>
                    </div>
                        <h1 class="text-4xl font-bold">Manchester Holidays 2026</h1>
                    </div>
                    <p class="text-lg opacity-90">Greater Manchester • Bank Holidays • Local Events • Festivals</p>
                    <p class="text-sm opacity-75">Patron Saint: St. Denys • Mayor of Manchester</p>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-city-primary to-city-secondary text-white rounded-lg shadow-lg p-6">
                ...
                <div class="space-y-2 text-sm">
                    <div class="flex justify-between">
                        <span>County:</span>
                        <span class="font-semibold">Greater Manchester</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Patron Saint:</span>
                        <span class="font-semibold">St. Denys</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Leadership:</span>
                        <span class="font-semibold">Mayor of Manchester</span>
                    </div>
                </div>
            </div>
        </div>
