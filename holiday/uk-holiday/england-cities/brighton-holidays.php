<?php 
// Brighton Holidays 2026 - Page specific head content
...
<title>Brighton Holidays 2026 | Complete Calendar | Local Events | Bank Holidays</title>
<meta name="description" content="Complete Brighton Holiday Calendar 2026. Find all bank holidays, local events, festivals, and observances. Plan your year with our comprehensive Brighton holiday guide.">
<meta name="keywords" content="Brighton holidays 2026, Brighton events, Brighton festivals, England holidays, Brighton calendar">
<style>
:root {
    --city-primary: #00BFFF;
    --city-secondary: #1E90FF;
}
...
<nav class="bg-white shadow-sm border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center space-x-2 py-3 text-sm">
            ...
            <i class="fas fa-chevron-right text-gray-400"></i>
            <span class="text-gray-600 font-medium">Brighton Holidays 2026</span>
        </div>
    </div>
</nav>

<?php
// Brighton Holidays 2026 Data
$holidays_2026 = array (
  '2026-01-01' => 
  array (
    'name' => 'New Year\'s Day',
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <div class="flex items-center space-x-3 mb-2">
                        ...
                        <i class="fa-solid fa-umbrella-beach text-2xl text-blue-500"></i>
                    </div>
                        <h1 class="text-4xl font-bold">Brighton Holidays 2026</h1>
                    </div>
                    <p class="text-lg opacity-90">East Sussex • Bank Holidays • Local Events • Festivals</p>
                    <p class="text-sm opacity-75">Patron Saint: St. Nicholas • Mayor of Brighton</p>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-city-primary to-city-secondary text-white rounded-lg shadow-lg p-6">
                ...
                <div class="space-y-2 text-sm">
                    <div class="flex justify-between">
                        <span>County:</span>
                        <span class="font-semibold">East Sussex</span>
                    </div>
                    <div class="flex justify-between">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-semibold">Mayor of Brighton</span>
                    </div>
                </div>
            </div>
        </div>
