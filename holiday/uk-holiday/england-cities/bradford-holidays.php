<?php 
// Bradford Holidays 2026 - Page specific head content
...
<title>Bradford Holidays 2026 | Complete Calendar | Local Events | Bank Holidays</title>
<meta name="description" content="Complete Bradford Holiday Calendar 2026. Find all bank holidays, local events, festivals, and observances. Plan your year with our comprehensive Bradford holiday guide.">
<meta name="keywords" content="Bradford holidays 2026, Bradford events, Bradford festivals, England holidays, Bradford calendar">
<style>
:root {
    --city-primary: #4B0082;
    --city-secondary: #8A2BE2;
}
...
<nav class="bg-white shadow-sm border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center space-x-2 py-3 text-sm">
            ...
            <i class="fas fa-chevron-right text-gray-400"></i>
            <span class="text-gray-600 font-medium">Bradford Holidays 2026</span>
        </div>
    </div>
</nav>

<?php
// Bradford Holidays 2026 Data
$holidays_2026 = array (
  '2026-01-01' => 
  array (
    'name' => 'New Year\'s Day',
  ...
  '2026-08-23' => 
  array (
    'name' => 'Bradford Literature Festival',
    'type' => 'Arts Festival',
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <div class="flex items-center space-x-3 mb-2">
                        ...
                        <i class="fa-solid fa-building text-2xl text-green-600"></i>
                    </div>
                        <h1 class="text-4xl font-bold">Bradford Holidays 2026</h1>
                    </div>
                    <p class="text-lg opacity-90">West Yorkshire • Bank Holidays • Local Events • Festivals</p>
                    <p class="text-sm opacity-75">Patron Saint: St. Peter • Lord Mayor of Bradford</p>
                </div>
            </div>
    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-center space-x-8 text-sm text-gray-700">
            ...
            <div class="flex items-center space-x-2">
                ...
                <span>Lord Mayor of Bradford</span>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="bg-gradient-to-br from-city-primary to-city-secondary text-white rounded-lg shadow-lg p-6">
                ...
                <div class="space-y-2 text-sm">
                    <div class="flex justify-between">
                        <span>County:</span>
                        <span class="font-semibold">West Yorkshire</span>
                    </div>
                    <div class="flex justify-between">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-semibold">Lord Mayor of Bradford</span>
                    </div>
                </div>
            </div>
        </div>
