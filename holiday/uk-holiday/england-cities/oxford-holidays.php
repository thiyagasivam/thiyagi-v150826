<?php 
// Oxford Holidays 2026 - Page specific head content
...
<title>Oxford Holidays 2026 | Complete Calendar | Local Events | Bank Holidays</title>
<meta name="description" content="Complete Oxford Holiday Calendar 2026. Find all bank holidays, local events, festivals, and observances. Plan your year with our comprehensive Oxford holiday guide.">
<meta name="keywords" content="Oxford holidays 2026, Oxford events, Oxford festivals, England holidays, Oxford calendar">
<style>
:root {
    --city-primary: #003366;
    --city-secondary: #0066CC;
}
...
<nav class="bg-white shadow-sm border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center space-x-2 py-3 text-sm">
            ...
            <i class="fas fa-chevron-right text-gray-400"></i>
            <span class="text-gray-600 font-medium">Oxford Holidays 2026</span>
        </div>
    </div>
</nav>

<?php
// Oxford Holidays 2026 Data
$holidays_2026 = array (
  '2026-01-01' => 
  array (
    'name' => 'New Year\'s Day',
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <div class="flex items-center space-x-3 mb-2">
                        ...
                        <i class="fa-solid fa-book text-2xl text-blue-800"></i>
                    </div>
                        <h1 class="text-4xl font-bold">Oxford Holidays 2026</h1>
                    </div>
                    <p class="text-lg opacity-90">Oxfordshire • Bank Holidays • Local Events • Festivals</p>
                    <p class="text-sm opacity-75">Patron Saint: St. Frideswide • Lord Mayor of Oxford</p>
                </div>
            </div>
    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-center space-x-8 text-sm text-gray-700">
            ...
            <div class="flex items-center space-x-2">
                ...
                <span>St. Frideswide</span>
            </div>
            <div class="flex items-center space-x-2">
                <i class="fas fa-user-tie text-city-primary"></i>
                <span>Lord Mayor of Oxford</span>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="bg-gradient-to-br from-city-primary to-city-secondary text-white rounded-lg shadow-lg p-6">
                ...
                <div class="space-y-2 text-sm">
                    <div class="flex justify-between">
                        <span>County:</span>
                        <span class="font-semibold">Oxfordshire</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Patron Saint:</span>
                        <span class="font-semibold">St. Frideswide</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Leadership:</span>
                        <span class="font-semibold">Lord Mayor of Oxford</span>
                    </div>
                </div>
            </div>
        </div>
