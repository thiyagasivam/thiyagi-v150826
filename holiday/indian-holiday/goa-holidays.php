<?php include '../../header.php'; ?>
    <title>Goa Holidays 2026 | Complete Calendar | Festivals | National Holidays</title>
    <meta name="description" content="Complete Goa Holiday Calendar 2026. Find all major festivals, national holidays, cultural events, and religious celebrations in Goa. Plan your year with our comprehensive guide.">
    <meta name="keywords" content="Goa holidays 2026, Goa festivals, Shigmo, Carnival, national holidays India, cultural events Goa, Goa calendar, holidays Goa, festival dates 2026">
    <meta name="author" content="Goa Holiday Calendar">
        <meta property="og:title" content="Goa Holidays 2026 - Complete Calendar">
    <meta property="og:description" content="Complete Goa Holiday Calendar 2026 with all festivals, national holidays, and cultural events. Plan your year with our comprehensive guide.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>">
    <meta property="og:image" content="https://via.placeholder.com/1200x630/FF4500/FFFFFF?text=Goa+Holidays+2026">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Goa Holidays 2026">
    <meta name="twitter:description" content="Complete Goa Holiday Calendar 2026 with all festivals and holidays.">
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "WebPage",
        "name": "Goa Holidays 2026",
        "description": "Complete Goa Holiday Calendar 2026 with all festivals, national holidays, and cultural events",
        ...
        "mainEntity": {
            ...
            "mainEntity": [
                {
                    "@type": "Question",
                    "name": "What are the main festivals in Goa in 2026?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "The main festivals in Goa in 2026 include Carnival (February 25 - March 1), Shigmo (March 13), and Feast of St. Francis Xavier (December 3)."
                    }
                },
                {
                    "@type": "Question",
                    "name": "How many national holidays are there in Goa 2026?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "There are several national holidays in Goa 2026 including Republic Day (January 26), Independence Day (August 15), and Gandhi Jayanti (October 2)."
                    }
                },
                {
                    "@type": "Question",
                    "name": "What is Carnival and why is it important?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Carnival is Goa's biggest festival, held annually before Lent. It's a vibrant celebration featuring parades, floats, music, dancing, and colorful costumes, reflecting Goa's Portuguese heritage."
                    }
                },
                {
                    "@type": "Question",
                    "name": "How is Independence Day celebrated in Goa?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Independence Day (August 15, 2026) is celebrated with great patriotic fervor in Goa. The day begins with flag hoisting ceremonies in schools, colleges, and government offices, often accompanied by cultural programs."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Are there any special holidays specific to Goa in 2026?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Yes, Goa has several state-specific holidays and festivals. Major ones include Shigmo, a spring harvest festival, and various Feast Days of patron saints, particularly prominent in the Christian communities."
                    }
                }
            ]
        },
    ...
    <script>
        tailwind.config = {
            theme: {
                extend: {
                    colors: {
                        'goa-orange': '#FF4500', // Vibrant Orange
                        'goa-blue': '#1E90FF',   // Dodger Blue
                        'goa-green': '#32CD32',  // Lime Green
                        'goa-yellow': '#FFD700'  // Gold
                    }
                }
            }
        }
...
<body class="bg-gradient-to-br from-blue-50 to-green-100 min-h-screen">
    <?php
    // Goa Holidays 2026 Data
    // Note: Dates for Shigmo and Carnival are estimates based on typical timing. Exact dates may vary.
    $holidays_2026 = [
        '2026-01-01' => [
            'name' => 'New Year\'s Day',
        ...
        '2026-02-25' => [ // Carnival Monday - Approximate date
            'name' => 'Carnival Monday',
            'type' => 'Goa Festival',
            'description' => 'First day of Goa Carnival',
            'icon' => 'fa-mask',
            'bank_holiday' => true
        ],
        '2026-02-26' => [ // Carnival Tuesday - Approximate date
            'name' => 'Carnival Tuesday',
            'type' => 'Goa Festival',
            'description' => 'Second day of Goa Carnival',
            'icon' => 'fa-mask',
            'bank_holiday' => true
        ],
        '2026-02-27' => [ // Carnival Wednesday - Approximate date
            'name' => 'Carnival Wednesday (Ash Wednesday)',
            'type' => 'Goa Festival',
            'description' => 'Final day of Goa Carnival',
            'icon' => 'fa-mask',
            'bank_holiday' => true
        ],
        '2026-03-08' => [
        ...
        '2026-03-13' => [ // Shigmo - Approximate date (Full Moon)
            'name' => 'Shigmo',
            'type' => 'Goa Festival',
        ...
        '2026-12-03' => [ // Feast of St. Francis Xavier - Approximate date
            'name' => 'Feast of St. Francis Xavier',
            'type' => 'Goa Festival',
            'description' => 'Patron Saint of Goa',
            'icon' => 'fa-church',
            'bank_holiday' => true
        ],
        '2026-12-25' => [
    ...
    $bank_holidays_2026 = [
        ...
        '2026-03-01' => [ // Carnival Saturday - Approximate date
            'name' => 'Carnival Saturday',
            'type' => 'Bank Holiday',
            'description' => 'Saturday before Carnival - Banks closed',
            'icon' => 'fa-university',
            'bank_holiday' => true
        ],
    ...
    ?>
    <!-- Header -->
    <header class="bg-gradient-to-r from-goa-orange to-goa-yellow text-white shadow-lg relative overflow-hidden">
        <!-- Background Pattern -->
        ...
        <div class="container mx-auto px-4 py-6 relative z-10">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-lg opacity-90 flex items-center space-x-2">
                            ...
                            <span>গোৱা বাদলি দিনস</span> <!-- Konkani -->
                        </p>
                    </div>
                </div>
            ...
            <div class="flex justify-center mt-6 space-x-8 opacity-60">
                ...
                <i class="fas fa-umbrella-beach text-2xl text-blue-200"></i>
                <i class="fas fa-star text-2xl text-yellow-200"></i>
                <i class="fas fa-heart text-2xl text-red-200"></i>
                <i class="fas fa-music text-2xl text-green-200"></i>
                <i class="fas fa-mask text-2xl text-purple-200"></i>
            </div>
        </div>
    </header>
    <!-- Main Content -->
    <main class="container mx-auto px-4 py-8">
        ...
        <nav class="mb-6 text-sm text-gray-600" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-2">
                ...
                <li><i class="fas fa-chevron-right text-xs"></i></li>
                <li><a href="#" class="hover:text-blue-600 transition-colors">Goa</a></li>
                <li><i class="fas fa-chevron-right text-xs"></i></li>
        ...
        <section class="mb-8 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg p-6 border-l-4 border-blue-500">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl font-bold text-gray-800 mb-4 flex items-center justify-center space-x-3">
                    ...
                    <span>Complete Goa Holiday Calendar 2026</span>
                    <i class="fas fa-star text-yellow-500"></i>
                </h2>
                <p class="text-lg text-gray-700 mb-4 leading-relaxed">
                    Welcome to the comprehensive Goa Holiday Calendar 2026! This detailed guide provides you with all the important dates,
                    festivals, and celebrations throughout the year. Whether you're planning a trip to the beaches of Goa, organizing events,
                    or simply want to stay informed about cultural celebrations, our calendar covers everything from vibrant local festivals
                    like Carnival and Shigmo to national holidays and international observances.
                </p>
                <div class="grid md:grid-cols-3 gap-4 mt-6">
                    <div class="bg-white p-4 rounded-lg shadow-sm border border-blue-200">
                        ...
                        <h3 class="font-semibold text-gray-800 mb-2">Goa Festivals</h3>
                        <p class="text-sm text-gray-600">Unique celebrations like Carnival, Shigmo, and patron saint feasts</p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm border border-blue-200">
        ...
        <div class="mb-6 bg-white rounded-lg shadow-md p-4 border-l-4 border-blue-500">
                ...
                <div class="flex-1 w-full md:w-96">
                    <div class="relative">
                        ...
                        <div id="searchSuggestions" class="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg hidden">
                            ...
                            <div class="p-2">
                                <button onclick="quickSearch('Carnival')" class="block w-full text-left px-3 py-2 hover:bg-blue-50 rounded text-sm flex items-center space-x-2">
                                    <i class="fas fa-mask text-purple-500"></i>
                                    <span>Carnival</span>
                                </button>
                                <button onclick="quickSearch('Shigmo')" class="block w-full text-left px-3 py-2 hover:bg-blue-50 rounded text-sm flex items-center space-x-2">
                                    <i class="fas fa-leaf text-green-500"></i>
                                    <span>Shigmo</span>
                                </button>
                                <button onclick="quickSearch('Feast')" class="block w-full text-left px-3 py-2 hover:bg-blue-50 rounded text-sm flex items-center space-x-2">
                                    <i class="fas fa-church text-blue-500"></i>
                                    <span>Feast</span>
                                </button>
                ...
                <div class="flex items-center space-x-3">
                    <div class="relative">
                        ...
                        <select id="filterType"
                            ...
                            <option value="Goa Festival">🏖️ Goa Festival</option>
            ...
            <div class="mt-4 text-center bg-gradient-to-r from-blue-50 to-green-50 p-3 rounded-lg border border-blue-200">
                <p class="text-sm text-gray-700 flex items-center justify-center space-x-2">
                    ...
                    <span>💡 Search tips: Try searching for "Carnival", "Shigmo", "Feast", or specific holiday names</span>
                ...
                <div class="flex items-center justify-center space-x-3 mb-2">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 flex items-center justify-center space-x-2">
                            ...
                            <span>Goa Month: <?php echo $month_names[$current_month]; ?></span>
                        </p>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="grid grid-cols-7 bg-gradient-to-r from-gray-100 to-gray-200 border-b">
                ...
                $tamil_weekdays = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat']; // Using English for simplicity, could use Konkani if available
            ...
            <div class="grid grid-cols-7">
                ...
                for ($day = 1; $day <= $days_in_month; $day++) {
                    ...
                    if ($is_bank_holiday) {
                        ...
                        $cell_classes .= ' bg-orange-50'; // Changed color for Goa
                    }
                    echo '<div class="' . $cell_classes . '">';
                    echo '<div class="text-lg font-semibold text-gray-800 mb-2">' . $day . '</div>';
                    if ($is_holiday) {
                        $holiday = $all_holidays_2026[$date];
                        $border_color = $is_bank_holiday ? 'border-blue-500' : 'border-orange-500'; // Changed color for Goa
                        $bg_color = $is_bank_holiday ? 'bg-blue-100' : 'bg-orange-100'; // Changed color for Goa
                        $text_color = $is_bank_holiday ? 'text-blue-800' : 'text-orange-800'; // Changed color for Goa
                        $desc_color = $is_bank_holiday ? 'text-blue-700' : 'text-orange-700'; // Changed color for Goa
                        ...
                        echo '<i class="fas ' . $holiday['icon'] . ' text-lg ' . ($is_bank_holiday ? 'text-blue-600' : 'text-orange-600') . '"></i>'; // Changed color for Goa
                        ...
                        echo '<i class="fas fa-tag ' . ($is_bank_holiday ? 'text-blue-500' : 'text-orange-500') . '"></i>'; // Changed color for Goa
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 border-l-4 border-green-500">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="text-center p-4 bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg border border-orange-200 hover:shadow-md transition-all"> <!-- Changed color -->
                        <div class="flex items-center justify-center space-x-2 mb-2">
                            <i class="fas fa-umbrella-beach text-orange-600 text-xl"></i> <!-- Changed icon and color -->
                            <div class="text-3xl font-bold text-orange-600"><?php echo count(array_filter($holidays_2026, function($h) { return $h['type'] === 'Goa Festival'; })); ?></div>
                        </div>
                        <div class="text-sm text-orange-700 font-medium">Goa Festivals</div> <!-- Changed text -->
        ...
        <div class="mt-8 bg-white rounded-lg shadow-lg p-6 border-l-4 border-blue-500">
            ...
            <p class="text-gray-600 mb-6">All major banks in Goa will be closed on these dates. Plan your banking activities accordingly.</p>
            ...
            <div class="mt-6 p-4 bg-white rounded-lg border border-blue-200">
                ...
                <div class="grid md:grid-cols-3 gap-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <ul class="text-xs text-blue-600 space-y-1">
                            <li>• Goa State Cooperative Bank</li>
                            ...
                            <li>• Foreign Banks (Branches in Goa)</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            <i class="fas fa-umbrella-beach text-orange-500"></i> <!-- Changed icon and color -->
                            <span>What are the main festivals in Goa in 2026?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            The main festivals in Goa in 2026 include <strong>Carnival</strong> (February 25 - March 1) - a vibrant Portuguese-influenced festival,
                            <strong>Shigmo</strong> (March 13) - the state's biggest spring festival, and
                            <strong>Feast of St. Francis Xavier</strong> (December 3) - a significant Christian celebration.
                        </p>
                    </div>
                    <!-- FAQ Item 2 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How many national holidays are there in Goa 2026?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Goa observes several national holidays in 2026 including <strong>Republic Day</strong> (January 26),
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            <i class="fas fa-mask text-purple-500"></i> <!-- Changed icon and color -->
                            <span>What is Carnival and why is it important?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Carnival</strong> is Goa's biggest festival, held annually before Lent (around February/March). It's a vibrant celebration
                            featuring parades, floats, music, dancing, and colorful costumes, reflecting Goa's rich Portuguese heritage and multicultural character.
                        </p>
                    </div>
                    <!-- FAQ Item 4 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            <i class="fas fa-leaf text-green-500"></i> <!-- Changed icon and color -->
                            <span>What is Shigmo and its significance?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Shigmo</strong> (March 13, 2026) is Goa's biggest spring festival, celebrating the harvest season.
                            It has both Hindu (Shigmotsav) and tribal (Dhakto Shigmo) forms, featuring traditional folk dances, music, and elaborate processions.
                            It's a time for communities to come together and celebrate Goa's agricultural and cultural heritage.
                        </p>
                    </div>
                    <!-- FAQ Item 5 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Are international holidays like Valentine's Day celebrated in Goa?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Yes, <strong>Valentine's Day</strong> (February 14, 2026) and other international holidays like
                            <strong>International Women's Day</strong> (March 8, 2026) are celebrated in Goa, especially in
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            <i class="fas fa-church text-blue-500"></i> <!-- Changed icon and color -->
                            <span>What are the major Feast Days in Goa?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Goa, with its significant Christian population, celebrates various Feast Days of patron saints.
                            The most prominent is the <strong>Feast of St. Francis Xavier</strong> (December 3, 2026), the patron saint of Goa.
                            Other notable feasts include the Feast of St. John the Baptist, Feast of St. Michael, and local church feasts.
                        </p>
                    </div>
                    <!-- FAQ Item 7 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Is Labour Day a public holiday in Goa?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Labour Day / May Day</strong> (May 1, 2026) is a public holiday in Goa. Banks, government offices,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How is Independence Day celebrated in Goa?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Independence Day</strong> (August 15, 2026) is celebrated with great patriotic fervor in Goa.
                            ...
                            The main celebration usually takes place at the Secretariat in Panaji.
                        </p>
                    </div>
                    <!-- FAQ Item 9 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What is the significance of Gandhi Jayanti in Goa?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Gandhi Jayanti</strong> (October 2, 2026) commemorates the birth anniversary of Mahatma Gandhi,
                            the Father of the Nation. In Goa, this day is observed with prayer meetings, seminars on Gandhian
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How is Children's Day celebrated in Goa?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Children's Day</strong> (November 14, 2026) celebrates the birth anniversary of India's first
                            Prime Minister, Jawaharlal Nehru. In Goa, schools organize special programs, cultural activities, and competitions for children.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            <i class="fas fa-star text-yellow-500"></i>
                            <span>Is Christmas celebrated in Goa?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Yes, <strong>Christmas</strong> (December 25, 2026) is celebrated with great enthusiasm in Goa,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What is the significance of International Women's Day in Goa?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>International Women's Day</strong> (March 8, 2026) is celebrated across Goa to recognize
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How far in advance should I plan for Goa festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            For major festivals like <strong>Carnival</strong> and <strong>Shigmo</strong>, it's recommended to
                            plan at least 2-3 months in advance, especially if you're planning to travel to Goa. These festivals
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Which areas in Goa are best for experiencing festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Panaji</strong> (capital city) hosts major official celebrations. <strong>Mapusa</strong> is famous for Shigmo processions.
                            <strong>St. Inez</strong> and <strong>Altinho</strong> in Panaji see vibrant Carnival parades.
                            Coastal areas like <strong>Calangute</strong> and <strong>Baga</strong> often have beachside events.
                            Many village churches host their own local feast celebrations throughout the year.
                        </p>
                    </div>
                    <!-- FAQ Item 15 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Are there any special holidays specific to Goa in 2026?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Yes, Goa has several state-specific holidays and festivals. <strong>Carnival</strong>,
                            <strong>Shigmo</strong>, and various <strong>Feast Days</strong> (like St. Francis Xavier) are unique to Goa
                            and are celebrated as state holidays or widely observed events. The state government may also declare
                            additional holidays for local events.
                        </p>
                    </div>
                    <!-- FAQ Item 16 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What traditional foods are associated with Goa festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Goa festivals feature a variety of traditional foods. <strong>Carnival</strong> sees street food stalls with snacks like
                            <em>chouriço</em> (spicy sausage), <em>bolinhos</em> (fritters), and <em>bebinca</em> (layered dessert).
                            During <strong>Shigmo</strong>, traditional Goan sweets like <em>neureos</em> and <em>khottem</em> are popular.
                            <strong>Christmas</strong> features elaborate meals with dishes like <em>vindaloo</em>, <em>sorpotel</em>,
                            and desserts like <em>doce</em> (sweets). <strong>Feast Days</strong> often include blessed food like <em>ros</em> (rice cakes).
                        </p>
                    </div>
                    <!-- FAQ Item 17 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What cultural activities are organized during Goa festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Goa festivals feature rich cultural activities including live music concerts, traditional folk dances
                            (like <em>Fugdi</em> and <em>Dekhnni</em>), colorful parades with floats, street plays, and cultural competitions.
                            <strong>Carnival</strong> is known for its elaborate masks and costumes. <strong>Shigmo</strong> features traditional
                            folk troupes performing. Many festivals also include art exhibitions, craft demonstrations, and food festivals.
                        </p>
                    </div>
                    <!-- FAQ Item 18 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How can tourists participate in Goa festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Tourists can participate in Goa festivals by attending public celebrations, visiting churches during
                            feast times, and joining community events. Many hotels and tour operators offer special festival packages.
                            It's recommended to dress appropriately (modest for religious events, festive for Carnival), respect local customs,
                            and participate in cultural activities. Learning basic greetings in Konkani or Portuguese can enhance the experience.
                        </p>
                    </div>
                    <!-- FAQ Item 19 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            Photography and videography are generally allowed during most Goa festivals, but it's important to
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            For detailed information about Goa festivals, you can visit the official Goa Tourism website,
                            contact local tourism offices, or check with local churches, cultural organizations, and event organizers.
    ...
    <script>
        ...
        function downloadCalendar() {
            ...
            const content = `Goa Holidays 2026
`;
            const blob = new Blob([content], { type: 'text/plain' });
            const url = window.URL.createObjectURL(blob);
            const a = document.createElement('a');
            a.href = url;
            a.download = 'goa-holidays-2026.txt';
            a.click();
        ...
        function shareCalendar() {
            if (navigator.share) {
                navigator.share({
                    title: 'Goa Holidays 2026',
                    text: 'Check out the Goa holiday calendar for 2026!',
