    ...
    <script type="application/ld+json">
    {
        ...
        "mainEntity": {
            ...
            "mainEntity": [
                ...
                {
                    "@type": "Question",
                    "name": "What is Bohag Bihu and why is it important?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Bohag Bihu, also known as Rongali Bihu, is the Assamese New Year festival, celebrated with much enthusiasm in Assam. It marks the onset of the agricultural season."
                    }
                },
                {
                    "@type": "Question",
            ...
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="grid md:grid-cols-3 gap-4 mt-6">
                    <div class="bg-white p-4 rounded-lg shadow-sm border border-blue-200">
                        ...
                        <p class="text-sm text-gray-600">Traditional celebrations like Bohag Bihu, Magh Bihu, and Me-Dam-Me-Phi</p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm border border-blue-200">
        ...
        <div class="mb-6 bg-white rounded-lg shadow-md p-4 border-l-4 border-blue-500">
                ...
                <div class="flex-1 w-full md:w-96">
                    <div class="relative">
                        ...
                        <div id="searchSuggestions" class="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg hidden">
                            ...
                            <div class="p-2">
                                <button onclick="quickSearch('Bihu')" class="block w-full text-left px-3 py-2 hover:bg-blue-50 rounded text-sm flex items-center space-x-2">
                                ...
                                <button onclick="quickSearch('Assam')" class="block w-full text-left px-3 py-2 hover:bg-blue-50 rounded text-sm flex items-center space-x-2">
                                    <i class="fas fa-flag text-red-500"></i>
                                    <span>Assam Festivals</span>
                                </button>
            ...
            <div class="mt-4 text-center bg-gradient-to-r from-blue-50 to-indigo-50 p-3 rounded-lg border border-blue-200">
                <p class="text-sm text-gray-700 flex items-center justify-center space-x-2">
                    ...
                    <span>💡 Search tips: Try searching for "Bihu", "Assam", "National", or specific holiday names</span>
            ...
            <div class="mt-6 p-4 bg-white rounded-lg border border-blue-200">
                ...
                <div class="grid md:grid-cols-3 gap-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <ul class="text-xs text-blue-600 space-y-1">
                            <li>• Assam Gramin Vikash Bank</li>
                            <li>• The Assam Co-operative Apex Bank Ltd</li>
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            <i class="fas fa-sun text-orange-500"></i>
                            <span>What is Bohag Bihu and why is it important?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Bohag Bihu</strong>, also known as Rongali Bihu, is the most important festival in Assam. It marks the beginning of the Assamese New Year and the onset of the agricultural season. 
                            The festival is celebrated with feasting, music, and traditional Bihu dance.
                        </p>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What is Me-Dam-Me-Phi?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Me-Dam-Me-Phi</strong> is a significant festival celebrated by the Ahom community in Assam on January 31st. It is a day to pay homage to the ancestors and to remember their contributions to society.
                        </p>
                    </div>
                </div>
            </div>
