<?php include '../../header.php'; ?>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            .critical-title { font-size: 2rem; }
            .critical-subtitle { font-size: 1rem; }
        }
    </style>
    <script>
        tailwind.config = {
...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
    ...
    <div id="loadingIndicator" class="fixed inset-0 bg-white z-50 flex items-center justify-center">
        <div class="text-center">
            ...
            <p class="text-gray-600 text-lg">Loading Andhra Pradesh Holidays...</p>
        </div>
    </div>
    <?php
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-lg opacity-90 flex items-center space-x-2">
                            ...
                            <span>ఆంధ్రప్రదేశ్ సెలవు రోజులు</span>
                        </p>
                    </div>
                </div>
    ...
    <main class="container mx-auto px-4 py-8">
            ...
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="grid md:grid-cols-3 gap-4 mt-6">
                    <div class="bg-white p-4 rounded-lg shadow-sm border border-blue-200">
                        ...
                        <h3 class="font-semibold text-gray-800 mb-2">Telugu Festivals</h3>
                        <p class="text-sm text-gray-600">Traditional celebrations like Ugadi, Sri Rama Navami, and cultural events</p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm border border-blue-200">
        ...
        <div class="mb-6 bg-white rounded-lg shadow-md p-4 border-l-4 border-blue-500">
                ...
                <div class="flex-1 w-full md:w-96">
                    <div class="relative">
                        ...
                        <div id="searchSuggestions" class="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg hidden">
                            ...
                            <div class="p-2">
                                <button onclick="quickSearch('Ugadi')" class="block w-full text-left px-3 py-2 hover:bg-blue-50 rounded text-sm flex items-center space-x-2">
                                    <i class="fas fa-sun text-orange-500"></i>
                                    <span>Ugadi</span>
                                </button>
                                <button onclick="quickSearch('Sri Rama Navami')" class="block w-full text-left px-3 py-2 hover:bg-blue-50 rounded text-sm flex items-center space-x-2">
                                    <i class="fas fa-calendar-plus text-green-500"></i>
                                    <span>Sri Rama Navami</span>
                                </button>
                                <button onclick="quickSearch('Telugu')" class="block w-full text-left px-3 py-2 hover:bg-blue-50 rounded text-sm flex items-center space-x-2">
                                    <i class="fas fa-flag text-red-500"></i>
                                    <span>Telugu Festivals</span>
                                </button>
                ...
                <div class="flex items-center space-x-3">
                    <div class="relative">
                        ...
                        <select id="filterType" 
                            ...
                            <option value="Telugu Festival">🌾 Telugu Festival</option>
                            <option value="Telugu Cultural">📚 Telugu Cultural</option>
            ...
            <div class="mt-4 text-center bg-gradient-to-r from-blue-50 to-indigo-50 p-3 rounded-lg border border-blue-200">
                <p class="text-sm text-gray-700 flex items-center justify-center space-x-2">
                    ...
                    <span>💡 Search tips: Try searching for "Ugadi", "Telugu", "National", or specific holiday names</span>
                ...
                <div class="flex items-center justify-center space-x-3 mb-2">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 flex items-center justify-center space-x-2">
                            ...
                            <span>తెలుగు నెల: <?php echo $month_names[$current_month]; ?></span>
                        </p>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="grid grid-cols-7 bg-gradient-to-r from-gray-100 to-gray-200 border-b">
                ...
                $telugu_weekdays = ['ఆదివారం', 'సోమవారం', 'మంగళవారం', 'బుధవారం', 'గురువారం', 'శుక్రవారం', 'శనివారం'];
                ...
                for ($i = 0; $i < 7; $i++) {
                    ...
                    echo '</div>';
                                            echo '<div class="text-xs text-gray-500">' . $telugu_weekdays[$i] . '</div>';
                    echo '</div>';
                }
                ?>
            </div>
            ...
            <div class="mt-6 p-4 bg-white rounded-lg border border-blue-200">
                ...
                <div class="grid md:grid-cols-3 gap-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <ul class="text-xs text-blue-600 space-y-1">
                            <li>• Andhra Pradesh State Cooperative Bank</li>
                            <li>• Andhra Bank (merged with Union Bank)</li>
                            <li>• Andhra Pradesh Gramin Vikas Bank</li>
                            <li>• Chaitanya Godavari Grameena Bank</li>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How far in advance should I plan for Andhra Pradesh festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            For major festivals like <strong>Ugadi</strong> and <strong>Sri Rama Navami</strong>, it's recommended to 
                            plan at least 2-3 months in advance, especially if you're planning to travel to Andhra Pradesh. These festivals 
                            attract many visitors, and accommodations and transportation can be booked up quickly. Early planning ensures 
                            a better experience.
                        </p>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Which cities in Andhra Pradesh are best for experiencing festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Vijayawada</strong> is famous for its grand Ugadi celebrations and temple festivals, 
                            <strong>Visakhapatnam</strong> celebrates all festivals with coastal cultural elements, 
                            <strong>Tirupati</strong> is renowned for its religious festivals and temple celebrations, and 
                            <strong>Guntur</strong> showcases traditional Telugu culture during major festivals.
                        </p>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            ...
                            <strong>Sri Rama Navami</strong> are unique to Andhra Pradesh and are celebrated as state holidays. 
                            Additionally, the state observes <strong>Andhra Pradesh Formation Day</strong> and other regional celebrations 
                            that reflect the rich cultural heritage of the Telugu people.
                        </p>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What traditional foods are associated with Andhra Pradesh festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Andhra Pradesh festivals feature a variety of traditional foods. <strong>Ugadi</strong> is celebrated with 
                            the special Ugadi Pachadi (a mix of six tastes), <strong>Sri Rama Navami</strong> includes special prasadams 
                            and traditional Telugu sweets. The state is famous for its spicy cuisine, and festivals showcase dishes like 
                            Pulihora, Payasam, and various rice preparations.
                        </p>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What cultural activities are organized during Telugu festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Telugu festivals feature rich cultural activities including classical music concerts, traditional dance 
                            performances (Kuchipudi), folk dances, poetry recitations, and cultural competitions. <strong>Ugadi</strong> 
                            celebrations include Panchangam reading, cultural programs, and traditional games. <strong>Sri Rama Navami</strong> 
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How can tourists participate in Andhra Pradesh festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Tourists can participate in Andhra Pradesh festivals by attending public celebrations, visiting temples during 
                            special occasions, and joining community events. Many hotels and tour operators offer special festival packages. 
                            Learning basic Telugu greetings and festival customs can enhance the experience significantly. 
                            Respecting local traditions and dress codes is important for a meaningful participation.
                        </p>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Are photography and videography allowed during Andhra Pradesh festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Photography and videography are generally allowed during most Andhra Pradesh festivals, but it's important to 
                            respect local customs and seek permission when photographing religious ceremonies. Some temples may have 
                            restrictions on photography inside sanctums. Always be mindful of others' privacy and maintain decorum during 
                            religious events.
                        </p>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Where can I get more information about Andhra Pradesh festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            For detailed information about Andhra Pradesh festivals, you can visit the official Andhra Pradesh Tourism website, 
                            contact local tourism offices, or consult with local cultural organizations. Many temples and cultural centers 
                            provide information about upcoming festivals and events. Social media platforms and local news sources also 
                            regularly update festival schedules and celebrations.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <script>
        // JavaScript functionality - Performance Optimized
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Performance: Use passive event listeners and requestAnimationFrame
        ...
        document.addEventListener('keydown', function(e) {
            // Performance: Cache URL parsing
            if (!window.cachedUrl) {
                window.cachedUrl = new URL(window.location);
                window.cachedMonth = parseInt(window.cachedUrl.searchParams.get('month')) || new Date().getMonth() + 1;
                window.cachedYear = parseInt(window.cachedUrl.searchParams.get('year')) || new Date().getFullYear();
            }

            if (e.key === 'ArrowLeft') {
                // Previous month
                const prevMonth = window.cachedMonth === 1 ? 12 : window.cachedMonth - 1;
                const prevYear = window.cachedMonth === 1 ? window.cachedYear - 1 : window.cachedYear;
                window.location.href = `?month=${prevMonth}&year=${prevYear}`;
            } else if (e.key === 'ArrowRight') {
                // Next month
                const nextMonth = window.cachedMonth === 12 ? 1 : window.cachedMonth + 1;
                const nextYear = window.cachedMonth === 12 ? window.cachedYear + 1 : window.cachedYear;
