<?php include '../../header.php'; ?>
    <title>Telangana Holidays 2026 | Complete Calendar | Festivals | National Holidays</title>
    <meta name="description" content="Complete Telangana Holiday Calendar 2026. Find all state festivals like Bathukamma, Bonalu, national holidays, cultural events, and religious celebrations. Plan your year with our comprehensive holiday guide.">
    <meta name="keywords" content="Telangana holidays 2026, Bathukamma, Bonalu, Sankranti, national holidays India, cultural events Telangana, Telangana calendar, holidays Telangana, festival dates 2026">
    <meta name="author" content="Telangana Holiday Calendar">
        <meta property="og:title" content="Telangana Holidays 2026 - Complete Calendar">
    <meta property="og:description" content="Complete Telangana Holiday Calendar 2026 with all festivals, national holidays, and cultural events. Plan your year with our comprehensive guide.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>">
    <meta property="og:image" content="https://via.placeholder.com/1200x630/FF8C00/FFFFFF?text=Telangana+Holidays+2026">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Telangana Holidays 2026">
    <meta name="twitter:description" content="Complete Telangana Holiday Calendar 2026 with all festivals and holidays.">
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "WebPage",
        "name": "Telangana Holidays 2026",
        "description": "Complete Telangana Holiday Calendar 2026 with all festivals, national holidays, and cultural events",
        ...
        "mainEntity": {
            ...
            "mainEntity": [
                {
                    "@type": "Question",
                    "name": "What are the main festivals in Telangana in 2026?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "The main festivals in Telangana in 2026 include Bathukamma (dates vary by month), Bonalu (July/August), Sankranti (January 14-15), and Dasara (October)."
                    }
                },
                {
                    "@type": "Question",
                    "name": "How many national holidays are there in Telangana 2026?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "There are several national holidays in Telangana 2026 including Republic Day (January 26), Independence Day (August 15), and Gandhi Jayanti (October 2)."
                    }
                },
                {
                    "@type": "Question",
                    "name": "What is Bathukamma and why is it important?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Bathukamma is a vibrant floral festival celebrated predominantly by women in Telangana. It symbolizes the cultural identity of the state and is celebrated during Navratri, usually in September or October, depending on the lunar calendar."
                    }
                },
                {
                    "@type": "Question",
                    "name": "How is Sankranti celebrated in Telangana?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Sankranti (Makara Sankranti) is celebrated with great enthusiasm in Telangana on January 14th. It marks the harvest season and the sun's transition into Capricorn. Celebrations include flying kites, preparing traditional sweets like chikkis and ariselu, and colorful decorations."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Are there any special holidays specific to Telangana in 2026?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Yes, Telangana has several state-specific holidays and festivals. Bathukamma, Bonalu, and Telangana Formation Day (June 2) are unique to the state and are celebrated as state holidays."
                    }
                }
            ]
        },
        "publisher": {
            "@type": "Organization",
            "name": "Telangana Holiday Calendar"
        },
    ...
    <script>
        tailwind.config = {
            theme: {
                extend: {
                    colors: {
                        'tg-orange': '#FF8C00', /* Orange for Telangana */
                        'tg-green': '#228B22', /* Green for festivals */
                        'tg-blue': '#0000CD',   /* Blue for water/kites */
                        'tg-red': '#DC143C'     /* Red for energy */
                    }
                }
            }
        }
...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
    ...
    $holidays_2026 = [
        ...
        '2026-01-14' => [
            ...
            'type' => 'State Festival',
            'description' => 'Harvest festival celebrated with kites and sweets',
            'icon' => 'fa-sun',
            'bank_holiday' => true
        ],
        '2026-01-15' => [
            'name' => 'Sankranti Holiday',
            'type' => 'State Festival',
            'description' => 'Second day of Sankranti celebrations',
            'icon' => 'fa-wind',
            'bank_holiday' => true
        ],
        '2026-01-26' => [
        ...
        '2026-06-02' => [
            ...
            'type' => 'State Holiday',
            'description' => 'Celebration of the formation of Telangana state',
            'icon' => 'fa-map',
            'bank_holiday' => true
        ],
        '2026-08-15' => [
        ...
        '2026-10-03' => [
            'name' => 'Dasara',
            'type' => 'State Festival',
            'description' => 'Victory of good over evil, celebrated with Dussehra',
            'icon' => 'fa-crown',
            'bank_holiday' => true
        ],
        '2026-11-14' => [
    ...
    // Bank Holidays 2026 - Additional holidays specific to banks (includes major religious festivals)
    $bank_holidays_2026 = [
        '2026-01-28' => [
            'name' => 'Republic Day (Observed)',
            'type' => 'Bank Holiday',
            'description' => 'Republic Day observed - Banks closed',
            'icon' => 'fa-university',
            'bank_holiday' => true
        ],
        '2026-02-19' => [
        ...
        '2026-07-20' => [
            'name' => 'Bonalu',
            'type' => 'Bank Holiday',
            'description' => 'Festival dedicated to Goddess Mahankali - Banks closed',
            'icon' => 'fa-university',
            'bank_holiday' => true
        ],
        '2026-08-26' => [
        ...
        '2026-10-06' => [
            'name' => 'Bathukamma (Navratri)',
            'type' => 'Bank Holiday',
            'description' => 'Floral festival - Banks closed',
            'icon' => 'fa-university',
            'bank_holiday' => true
        ],
        '2026-10-31' => [
    ...
    ?>
    <!-- Header -->
    <header class="bg-gradient-to-r from-tg-orange to-tg-red text-white shadow-lg relative overflow-hidden">
        <!-- Background Pattern -->
        ...
        <div class="container mx-auto px-4 py-6 relative z-10">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-4xl font-bold flex items-center space-x-3">
                            <span>Telangana Holidays 2026</span>
            ...
            <div class="flex justify-center mt-6 space-x-8 opacity-60">
                ...
                <i class="fas fa-wind text-2xl text-blue-200"></i>
    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <nav class="mb-6 text-sm text-gray-600" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-2">
                ...
                <li><i class="fas fa-chevron-right text-xs"></i></li>
                <li><a href="#" class="hover:text-blue-600 transition-colors">Telangana</a></li>
                <li><i class="fas fa-chevron-right text-xs"></i></li>
        ...
        <section class="mb-8 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 border-l-4 border-blue-500">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl font-bold text-gray-800 mb-4 flex items-center justify-center space-x-3">
                    ...
                    <span>Complete Telangana Holiday Calendar 2026</span>
                    <i class="fas fa-star text-yellow-500"></i>
                </h2>
                <p class="text-lg text-gray-700 mb-4 leading-relaxed">
                    Welcome to the comprehensive Telangana Holiday Calendar 2026! This detailed guide provides you with all the important dates,
                    festivals, and celebrations throughout the year. Whether you're planning a trip to Telangana, organizing events,
                    or simply want to stay informed about cultural celebrations, our calendar covers everything from traditional Telangana festivals
                    like Bathukamma and Bonalu to national holidays and international observances.
                </p>
                <div class="grid md:grid-cols-3 gap-4 mt-6">
                    <div class="bg-white p-4 rounded-lg shadow-sm border border-blue-200">
                        ...
                        <p class="text-sm text-gray-600">Unique celebrations like Bathukamma, Bonalu, Sankranti, and Formation Day</p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm border border-blue-200">
        ...
        <div class="mb-6 bg-white rounded-lg shadow-md p-4 border-l-4 border-blue-500">
                ...
                <div class="flex-1 w-full md:w-96">
                    <div class="relative">
                        ...
                        <div id="searchSuggestions" class="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg hidden">
                            ...
                            <div class="p-2">
                                <button onclick="quickSearch('Bathukamma')" class="block w-full text-left px-3 py-2 hover:bg-blue-50 rounded text-sm flex items-center space-x-2">
                                    <i class="fas fa-sun text-orange-500"></i>
                                    <span>Bathukamma</span>
                                </button>
                                <button onclick="quickSearch('Bonalu')" class="block w-full text-left px-3 py-2 hover:bg-blue-50 rounded text-sm flex items-center space-x-2">
                                    <i class="fas fa-fire text-red-500"></i>
                                    <span>Bonalu</span>
                                </button>
                                <button onclick="quickSearch('Sankranti')" class="block w-full text-left px-3 py-2 hover:bg-blue-50 rounded text-sm flex items-center space-x-2">
                ...
                <div class="flex items-center space-x-3">
                    <div class="relative">
                        ...
                        <select id="filterType"
                            ...
                            <option value="State Holiday">🏛️ State Holiday</option>
            ...
            <div class="mt-4 text-center bg-gradient-to-r from-blue-50 to-indigo-50 p-3 rounded-lg border border-blue-200">
                <p class="text-sm text-gray-700 flex items-center justify-center space-x-2">
                    ...
                    <span>💡 Search tips: Try searching for "Bathukamma", "Bonalu", "Sankranti", "National", or specific holiday names</span>
                ...
                <div class="flex items-center justify-center space-x-3 mb-2">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 flex items-center justify-center space-x-2">
                            ...
                            <span>తెలంగాణ నెల: <?php echo $month_names[$current_month]; ?></span>
                        </p>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="grid grid-cols-7 bg-gradient-to-r from-gray-100 to-gray-200 border-b">
                ...
                $telangana_weekdays = ['ఆదివారం', 'సోమవారం', 'మంగళవారం', 'బుధవారం', 'గురువారం', 'శుక్రవారం', 'శనివారం'];
                ...
                for ($i = 0; $i < 7; $i++) {
                    ...
                    echo '</div>';
                    echo '<div class="text-xs text-gray-500">' . $telangana_weekdays[$i] . '</div>';
                    echo '</div>';
                }
                ?>
            </div>
            ...
            <div class="grid grid-cols-7">
                ...
                for ($day = 1; $day <= $days_in_month; $day++) {
                    ...
                    if ($is_bank_holiday) {
                        ...
                        $cell_classes .= ' bg-orange-50'; // Changed color for Telangana holidays
                    }
                    echo '<div class="' . $cell_classes . '">';
                    echo '<div class="text-lg font-semibold text-gray-800 mb-2">' . $day . '</div>';
                    if ($is_holiday) {
                        $holiday = $all_holidays_2026[$date];
                        $border_color = $is_bank_holiday ? 'border-blue-500' : 'border-orange-500'; // Changed border color
                        $bg_color = $is_bank_holiday ? 'bg-blue-100' : 'bg-orange-100'; // Changed background color
                        $text_color = $is_bank_holiday ? 'text-blue-800' : 'text-orange-800'; // Changed text color
                        $desc_color = $is_bank_holiday ? 'text-blue-700' : 'text-orange-700'; // Changed description color
                        ...
                        echo '<i class="fas ' . $holiday['icon'] . ' text-lg ' . ($is_bank_holiday ? 'text-blue-600' : 'text-orange-600') . '"></i>'; // Changed icon color
                        ...
                        echo '<i class="fas fa-tag ' . ($is_bank_holiday ? 'text-blue-500' : 'text-orange-500') . '"></i>'; // Changed tag color
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 border-l-4 border-green-500">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="text-center p-4 bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg border border-orange-200 hover:shadow-md transition-all"> <!-- Changed color -->
                        <div class="flex items-center justify-center space-x-2 mb-2">
                            <i class="fas fa-flag text-orange-600 text-xl"></i> <!-- Changed icon color -->
                            <div class="text-3xl font-bold text-orange-600"><?php echo count(array_filter($holidays_2026, function($h) { return $h['type'] === 'State Festival'; })); ?></div> <!-- Changed filter -->
                        </div>
                        <div class="text-sm text-orange-700 font-medium">State Festivals</div> <!-- Changed text -->
                        <div class="text-xs text-orange-600 mt-1">🌾 Cultural</div> <!-- Changed text color -->
                    </div>
        ...
        <div class="mt-8 bg-white rounded-lg shadow-lg p-6 border-l-4 border-blue-500">
            ...
            <p class="text-gray-600 mb-6">All major banks in Telangana will be closed on these dates. Plan your banking activities accordingly.</p>
            ...
            <div class="mt-6 p-4 bg-white rounded-lg border border-blue-200">
                <h4 class="font-semibold text-blue-800 mb-3 flex items-center">
                    ...
                    Major Banks Affected in Telangana
                </h4>
                <div class="grid md:grid-cols-3 gap-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <ul class="text-xs text-blue-600 space-y-1">
                            <li>• Telangana State Cooperative Apex Bank</li>
                            <li>• TS District Central Cooperative Banks</li>
                            <li>• TS Primary Agricultural Credit Societies</li>
                            <li>• City Union Bank</li>
                            <li>• Andhra Pradesh State Cooperative Bank (serves TG too)</li>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What are the main festivals in Telangana in 2026?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            The main festivals in Telangana in 2026 include <strong>Bathukamma</strong> (dates vary by month, usually Navratri),
                            <strong>Bonalu</strong> (July/August) - a vibrant festival dedicated to Goddess Mahankali,
                            <strong>Sankranti</strong> (January 14-15) - celebrating the harvest season with kites,
                            and <strong>Dasara</strong> (October) - celebrating the victory of good over evil.
                        </p>
                    </div>
                    <!-- FAQ Item 2 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How many national holidays are there in Telangana 2026?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Telangana observes several national holidays in 2026 including <strong>Republic Day</strong> (January 26),
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            <i class="fas fa-sun text-orange-500"></i> <!-- Changed icon -->
                            <span>What is Bathukamma and why is it important?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Bathukamma</strong> is a vibrant floral festival celebrated predominantly by women in Telangana.
                            It symbolizes the cultural identity of the state and is celebrated during Navratri, usually in September or October,
                            depending on the lunar calendar. Women create beautiful flower stacks and sing traditional songs around them.
                        </p>
                    </div>
                    <!-- FAQ Item 4 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            <i class="fas fa-fire text-red-500"></i> <!-- Changed icon -->
                            <span>What is Bonalu and its significance?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Bonalu</strong> (July/August 2026) is a popular Hindu festival dedicated to Goddess Mahankali,
                            primarily celebrated in Hyderabad and Secunderabad. It involves offering 'Bonalu' (a rice dish cooked with jaggery and milk)
                            to the goddess. The festival features colorful processions, traditional drummers (Dhimsa), and dancing, symbolizing devotion and community spirit.
                        </p>
                    </div>
                    <!-- FAQ Item 5 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Are international holidays like Valentine's Day celebrated in Telangana?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Yes, <strong>Valentine's Day</strong> (February 14, 2026) and other international holidays like
                            <strong>International Women's Day</strong> (March 8, 2026) are celebrated in Telangana, especially in
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What is the significance of Sankranti in Telangana?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Sankranti</strong> (Makara Sankranti) is celebrated with great enthusiasm in Telangana on January 14th, 2026.
                            It marks the harvest season and the sun's transition into Capricorn. Celebrations include flying kites,
                            preparing traditional sweets like chikkis and ariselu, and colorful decorations. It's a time for family gatherings and expressing gratitude.
                        </p>
                    </div>
                    <!-- FAQ Item 7 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Is Labour Day a public holiday in Telangana?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Labour Day</strong> (May 1, 2026) is celebrated as <strong>International Workers' Day</strong>
                            in Telangana. While it's not always a complete public holiday, many government offices and educational
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How is Independence Day celebrated in Telangana?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Independence Day</strong> (August 15, 2026) is celebrated with great patriotic fervor across Telangana.
                            ...
                            place at the Secretariat in Hyderabad with the Chief Minister's address.
                        </p>
                    </div>
                    <!-- FAQ Item 9 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What is the significance of Gandhi Jayanti in Telangana?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Gandhi Jayanti</strong> (October 2, 2026) commemorates the birth anniversary of Mahatma Gandhi,
                            the Father of the Nation. In Telangana, this day is observed with prayer meetings, seminars on Gandhian
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How is Children's Day celebrated in Telangana?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Children's Day</strong> (November 14, 2026) celebrates the birth anniversary of India's first
                            Prime Minister, Jawaharlal Nehru, who was fondly called "Chacha Nehru" by children. In Telangana, schools
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            <i class="fas fa-star text-yellow-500"></i>
                            <span>Is Christmas celebrated in Telangana?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Yes, <strong>Christmas</strong> (December 25, 2026) is celebrated with great enthusiasm in Telangana,
                            especially in areas with significant Christian populations like Hyderabad. Churches
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What is the significance of International Women's Day in Telangana?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>International Women's Day</strong> (March 8, 2026) is celebrated across Telangana to recognize
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How far in advance should I plan for Telangana festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            For major festivals like <strong>Bathukamma</strong> and <strong>Bonalu</strong>, it's recommended to
                            plan at least 2-3 months in advance, especially if you're planning to travel to Telangana. These festivals
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Which cities in Telangana are best for experiencing festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Hyderabad</strong> (capital city) offers grand celebrations for all major festivals, <strong>Warangal</strong>
                            is famous for its historical significance and traditional festivals, <strong>Karimnagar</strong> celebrates Bonalu with great enthusiasm,
                            and <strong>Nizamabad</strong> is known for its rural charm and local celebrations. Each city has its unique way of celebrating
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Are there any special holidays specific to Telangana in 2026?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Yes, Telangana has several state-specific holidays and festivals. <strong>Bathukamma</strong>,
                            <strong>Bonalu</strong>, and <strong>Telangana Formation Day</strong> (June 2) are unique to Telangana and are celebrated as state holidays.
                            Additionally, various temple festivals and local celebrations occur throughout the year, though these
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What traditional foods are associated with Telangana festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Telangana festivals feature a variety of traditional foods. <strong>Bonalu</strong> is celebrated with
                            the namesake rice dish cooked with jaggery and milk, <strong>Sankranti</strong> includes chikkis (peanut brittle) and ariselu.
                            During Bathukamma, women prepare special offerings and share traditional snacks. Most festivals include
                            traditional rice dishes, sweets like double ka meetha, and special <em>prasadam</em> offerings.
                        </p>
                    </div>
                    <!-- FAQ Item 17 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What cultural activities are organized during Telangana festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Telangana festivals feature rich cultural activities including traditional folk music (like Lambadi, Kolattam),
                            dance performances (Perini Shivatandavam), folk dances, poetry recitations, and cultural competitions.
                            <strong>Bonalu</strong> includes vibrant processions and drumming, <strong>Bathukamma</strong> features women dancing around floral arrangements.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How can tourists participate in Telangana festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Tourists can participate in Telangana festivals by attending public celebrations, visiting temples during
                            ...
                            Learning basic Telugu greetings and festival customs can enhance the experience significantly.
                        </p>
                    </div>
                    <!-- FAQ Item 19 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            Photography and videography are generally allowed during most Telangana festivals, but it's important to
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            For detailed information about Telangana festivals, you can visit the official Telangana Tourism website,
    ...
    <script>
        ...
        function downloadCalendar() {
            ...
            const content = `Telangana Holidays 2026
`;
            const blob = new Blob([content], { type: 'text/plain' });
            const url = window.URL.createObjectURL(blob);
            const a = document.createElement('a');
            a.href = url;
            a.download = 'telangana-holidays-2026.txt';
            a.click();
        ...
        function shareCalendar() {
            if (navigator.share) {
                navigator.share({
                    title: 'Telangana Holidays 2026',
                    text: 'Check out the Telangana holiday calendar for 2026!',
