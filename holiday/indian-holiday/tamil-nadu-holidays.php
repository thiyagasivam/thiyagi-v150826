<?php include '../../header.php'; ?>
    ...
    <title>Tamil Nadu Holidays 2026 | Complete Calendar | Tamil Festivals | National Holidays</title>
    <meta name="description" content="Complete Tamil Nadu Holiday Calendar 2026. Find all Tamil festivals, national holidays, cultural events, and religious celebrations. Plan your year with our comprehensive holiday guide.">
    <meta name="keywords" content="Tamil Nadu holidays 2026, Tamil festivals, Pongal, Tamil New Year, national holidays India, Tamil cultural events, Tamil Nadu calendar, holidays Tamil Nadu, festival dates 2026">
    <meta name="author" content="Tamil Nadu Holiday Calendar">
        <meta property="og:title" content="Tamil Nadu Holidays 2026 - Complete Calendar">
    <meta property="og:description" content="Complete Tamil Nadu Holiday Calendar 2026 with all festivals, national holidays, and cultural events. Plan your year with our comprehensive guide.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>">
    <meta property="og:image" content="https://via.placeholder.com/1200x630/FF0000/FFFFFF?text=Tamil+Nadu+Holidays+2026">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Tamil Nadu Holidays 2026">
    <meta name="twitter:description" content="Complete Tamil Nadu Holiday Calendar 2026 with all festivals and holidays.">
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "Complete Tamil Nadu Holiday Calendar 2026 with all festivals, national holidays, and cultural events",
        ...
        "mainEntity": {
            ...
            "mainEntity": [
                {
                    "@type": "Question",
                    "name": "What are the main Tamil festivals in 2026?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "The main Tamil festivals in 2026 include Pongal (January 15), Tamil New Year (March 21), and Chithirai New Year (April 14)."
                    }
                },
                {
                    "@type": "Question",
                    "name": "How many national holidays are there in Tamil Nadu 2026?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "There are several national holidays in Tamil Nadu 2026 including Republic Day (January 26), Independence Day (August 15), and Gandhi Jayanti (October 2)."
                    }
                },
                {
                    "@type": "Question",
                    "name": "What is Pongal and why is it important?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Pongal is one of the most important Tamil festivals, celebrated on January 15, 2026. It's a four-day harvest festival that marks the end of the winter solstice and the beginning of the sun's northward journey."
                    }
                },
                {
                    "@type": "Question",
                    "name": "How is Independence Day celebrated in Tamil Nadu?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Independence Day (August 15, 2026) is celebrated with great patriotic fervor across Tamil Nadu. The day begins with flag hoisting ceremonies in schools, colleges, and government offices."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Are there any special holidays specific to Tamil Nadu in 2026?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Yes, Tamil Nadu has several state-specific holidays and festivals. Pongal and Thiruvalluvar Day are unique to Tamil Nadu and are celebrated as state holidays."
                    }
                }
            ]
        },
...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-4xl font-bold flex items-center space-x-3">
                            <span>Tamil Nadu Holidays 2026</span>
                        ...
                        <p class="text-lg opacity-90 flex items-center space-x-2">
                            ...
                            <span>தமிழ்நாடு விடுமுறை நாட்கள்</span>
                        </p>
                    </div>
                </div>
    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <section class="mb-8 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 border-l-4 border-blue-500">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl font-bold text-gray-800 mb-4 flex items-center justify-center space-x-3">
                    ...
                    <span>Complete Tamil Nadu Holiday Calendar 2026</span>
                    <i class="fas fa-star text-yellow-500"></i>
                </h2>
                <p class="text-lg text-gray-700 mb-4 leading-relaxed">
                    Welcome to the comprehensive Tamil Nadu Holiday Calendar 2026! This detailed guide provides you with all the important dates, 
                    festivals, and celebrations throughout the year. Whether you're planning a trip to Tamil Nadu, organizing events, 
                ...
                <div class="flex items-center justify-center space-x-3 mb-2">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 flex items-center justify-center space-x-2">
                            ...
                            <span>தமிழ் மாதம்: <?php echo $month_names[$current_month]; ?></span>
                        </p>
                    </div>
                </div>
        ...
        <div class="mt-8 bg-white rounded-lg shadow-lg p-6 border-l-4 border-blue-500">
            ...
            <p class="text-gray-600 mb-6">All major banks in Tamil Nadu will be closed on these dates. Plan your banking activities accordingly.</p>
            ...
            <div class="mt-6 p-4 bg-white rounded-lg border border-blue-200">
                ...
                <div class="grid md:grid-cols-3 gap-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <ul class="text-xs text-blue-600 space-y-1">
                            <li>• Tamil Nadu State Apex Bank</li>
                            <li>• Tamil Nadu Mercantile Bank</li>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What are the main Tamil festivals in 2026?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            The main Tamil festivals in 2026 include <strong>Pongal</strong> (January 15) - the harvest festival, 
                            ...
                            are deeply rooted in Tamil culture and are celebrated with great enthusiasm across Tamil Nadu.
                        </p>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            <i class="fas fa-flag text-red-500"></i>
                            <span>How many national holidays are there in Tamil Nadu 2026?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Tamil Nadu observes several national holidays in 2026 including <strong>Republic Day</strong> (January 26), 
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            <i class="fas fa-sun text-orange-500"></i>
                            <span>What is Pongal and why is it important?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Pongal</strong> is one of the most important Tamil festivals, celebrated on January 15, 2026. 
                            It's a four-day harvest festival that marks the end of the winter solstice and the beginning of the sun's 
                            northward journey. The festival is dedicated to the Sun God and includes cooking the traditional Pongal dish, 
                            decorating cattle, and expressing gratitude for the harvest.
                        </p>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What is Thiruvalluvar Day and its significance?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            ...
                            with cultural programs and literary events across Tamil Nadu.
                        </p>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Are international holidays like Valentine's Day celebrated in Tamil Nadu?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Yes, <strong>Valentine's Day</strong> (February 14, 2026) and other international holidays like 
                            <strong>International Women's Day</strong> (March 8, 2026) are celebrated in Tamil Nadu, especially in 
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What is the difference between Tamil New Year and Chithirai New Year?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            ...
                            significance and are celebrated with traditional rituals and family gatherings.
                        </p>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Is Labour Day a public holiday in Tamil Nadu?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Labour Day</strong> (May 1, 2026) is celebrated as <strong>International Workers' Day</strong> 
                            in Tamil Nadu. While it's not always a complete public holiday, many government offices and educational 
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How is Independence Day celebrated in Tamil Nadu?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Independence Day</strong> (August 15, 2026) is celebrated with great patriotic fervor across Tamil Nadu. 
                            ...
                            place at the Fort St. George in Chennai with the Chief Minister's address.
                        </p>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What is the significance of Gandhi Jayanti in Tamil Nadu?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Gandhi Jayanti</strong> (October 2, 2026) commemorates the birth anniversary of Mahatma Gandhi, 
                            the Father of the Nation. In Tamil Nadu, this day is observed with prayer meetings, seminars on Gandhian 
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How is Children's Day celebrated in Tamil Nadu?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Children's Day</strong> (November 14, 2026) celebrates the birth anniversary of India's first 
                            Prime Minister, Jawaharlal Nehru, who was fondly called "Chacha Nehru" by children. In Tamil Nadu, schools 
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            <i class="fas fa-star text-yellow-500"></i>
                            <span>Is Christmas celebrated in Tamil Nadu?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Yes, <strong>Christmas</strong> (December 25, 2026) is celebrated with great enthusiasm in Tamil Nadu, 
                            especially in areas with significant Christian populations like Chennai, Madurai, and Kanyakumari. Churches 
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What is the significance of International Women's Day in Tamil Nadu?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>International Women's Day</strong> (March 8, 2026) is celebrated across Tamil Nadu to recognize 
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How far in advance should I plan for Tamil Nadu festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            For major festivals like <strong>Pongal</strong> and <strong>Tamil New Year</strong>, it's recommended to 
                            plan at least 2-3 months in advance, especially if you're planning to travel to Tamil Nadu. These festivals 
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            <i class="fas fa-map-marker-alt text-red-500"></i>
                            <span>Which cities in Tamil Nadu are best for experiencing festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Chennai</strong> (capital city) offers grand celebrations for all major festivals, <strong>Madurai</strong> 
                            is famous for its traditional temple festivals, <strong>Coimbatore</strong> celebrates Pongal with great enthusiasm, 
                            and <strong>Thanjavur</strong> is known for its cultural festivals. Each city has its unique way of celebrating 
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Are there any special holidays specific to Tamil Nadu in 2026?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Yes, Tamil Nadu has several state-specific holidays and festivals. <strong>Pongal</strong> and 
                            <strong>Thiruvalluvar Day</strong> are unique to Tamil Nadu and are celebrated as state holidays. 
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What traditional foods are associated with Tamil Nadu festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Tamil Nadu festivals feature a variety of traditional foods. <strong>Pongal</strong> is celebrated with 
                            the sweet Pongal dish made of rice and jaggery, <strong>Pongal</strong> also includes savory versions. 
                            During Tamil New Year, people prepare special sweets like <em>Mangai Pachadi</em> and <em>Neem Flower Rasam</em>. 
                            Most festivals include traditional rice dishes, coconut-based sweets, and special <em>prasadam</em> offerings.
                        </p>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What cultural activities are organized during Tamil festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Tamil festivals feature rich cultural activities including classical music concerts, traditional dance 
                            performances (Bharatanatyam), folk dances, poetry recitations, and cultural competitions. <strong>Pongal</strong> 
                            includes traditional games, bull-taming events, and cultural programs. Many festivals also feature 
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How can tourists participate in Tamil Nadu festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Tourists can participate in Tamil Nadu festivals by attending public celebrations, visiting temples during 
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            Photography and videography are generally allowed during most Tamil Nadu festivals, but it's important to 
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            For detailed information about Tamil Nadu festivals, you can visit the official Tamil Nadu Tourism website, 
    ...
    <script>
        ...
        function downloadCalendar() {
            ...
            const content = `Tamil Nadu Holidays 2026\n\n`;
            const blob = new Blob([content], { type: 'text/plain' });
            const url = window.URL.createObjectURL(blob);
            const a = document.createElement('a');
            a.href = url;
            a.download = 'tamil-nadu-holidays-2026.txt';
            a.click();
        ...
        function shareCalendar() {
            if (navigator.share) {
                navigator.share({
                    ...
                    text: 'Check out the Tamil Nadu holiday calendar for 2026!',
