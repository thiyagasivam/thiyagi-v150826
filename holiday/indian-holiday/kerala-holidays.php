<?php include '../../header.php'; ?>
    <title>Kerala Holidays 2026 | Complete Calendar | Onam | National Holidays</title>
    <meta name="description" content="Complete Kerala Holiday Calendar 2026. Find all major festivals like Onam, national holidays, cultural events, and religious celebrations in Kerala. Plan your year with our comprehensive guide.">
    <meta name="keywords" content="Kerala holidays 2026, Kerala festivals, Onam, Vishu, national holidays India, cultural events Kerala, Kerala calendar, holidays Kerala, festival dates 2026">
    <meta name="author" content="Kerala Holiday Calendar">
        <meta property="og:title" content="Kerala Holidays 2026 - Complete Calendar">
    <meta property="og:description" content="Complete Kerala Holiday Calendar 2026 with all festivals, national holidays, and cultural events. Plan your year with our comprehensive guide.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>">
    <meta property="og:image" content="https://via.placeholder.com/1200x630/008000/FFFFFF?text=Kerala+Holidays+2026"> <!-- Green for Kerala -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Kerala Holidays 2026">
    <meta name="twitter:description" content="Complete Kerala Holiday Calendar 2026 with all festivals and holidays.">
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "WebPage",
        "name": "Kerala Holidays 2026",
        "description": "Complete Kerala Holiday Calendar 2026 with all festivals, national holidays, and cultural events",
        ...
        "mainEntity": {
            ...
            "mainEntity": [
                {
                    "@type": "Question",
                    "name": "What are the main festivals in Kerala in 2026?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "The main festivals in Kerala in 2026 include Onam (August 29), Vishu (April 14), and various temple festivals like Thrissur Pooram (May 13)."
                    }
                },
                {
                    "@type": "Question",
                    "name": "How many national holidays are there in Kerala 2026?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "There are several national holidays in Kerala 2026 including Republic Day (January 26), Independence Day (August 15), and Gandhi Jayanti (October 2)."
                    }
                },
                {
                    "@type": "Question",
                ...
                },
                {
                    ...
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Independence Day (August 15, 2026) is celebrated with great patriotic fervor in Kerala. The day begins with flag hoisting ceremonies in schools, colleges, and government offices, often accompanied by cultural programs."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Are there any special holidays specific to Kerala in 2026?",
                    "acceptedAnswer": {
                        "@type": "Answer",
...
<body class="bg-gradient-to-br from-green-50 to-blue-100 min-h-screen">
    ...
    $holidays_2026 = [
        ...
        '2026-01-14' => [ // Makaravilakku / Sabarimala Makara Jyothi - Approximate date
        ...
        '2026-02-24' => [ // MaShi Thirunal - Birthday of Travancore King - Approximate date
            'name' => 'MaShi Thirunal',
        ...
        '2026-04-14' => [ // Vishu - Approximate date
            'name' => 'Vishu',
            'type' => 'Kerala Festival',
        ...
        '2026-04-15' => [ // Vishu Holiday - Day after Vishu
            'name' => 'Vishu Holiday',
            'type' => 'Kerala Festival',
        ...
        '2026-05-13' => [ // Thrissur Pooram - Approximate date
        ...
        '2026-08-29' => [ // Onam - Approximate date (Chingam 1)
            'name' => 'Onam',
            'type' => 'Kerala Festival',
        ...
        '2026-08-30' => [ // Onam Holiday - Second day of Onam
            'name' => 'Onam Holiday',
            'type' => 'Kerala Festival',
    ...
    $bank_holidays_2026 = [
        ...
        '2026-04-02' => [ // Good Friday - Approximate date
            'name' => 'Good Friday',
            'type' => 'Bank Holiday',
        ...
        '2026-04-04' => [ // Easter Sunday - Approximate date
            'name' => 'Easter Sunday',
            'type' => 'Bank Holiday',
            'description' => 'Christian religious holiday - Banks closed',
            'icon' => 'fa-university',
        ...
        '2026-05-09' => [ // Buddha Purnima - Approximate date
            'name' => 'Buddha Purnima',
            'type' => 'Bank Holiday',
        ...
        '2026-10-31' => [ // Diwali - Approximate date
            'name' => 'Diwali',
            'type' => 'Bank Holiday',
        ...
        '2026-11-01' => [ // Diwali Holiday - Approximate date
            'name' => 'Diwali Holiday',
            'type' => 'Bank Holiday',
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-4xl font-bold flex items-center space-x-3">
                            <span>Kerala Holidays 2026</span>
                        ...
                        <p class="text-lg opacity-90 flex items-center space-x-2">
                            ...
                            <span>കേരള അവധിക്കാലങ്ങൾ</span> <!-- Malayalam -->
                        </p>
                    </div>
                </div>
    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <section class="mb-8 bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-6 border-l-4 border-green-500">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl font-bold text-gray-800 mb-4 flex items-center justify-center space-x-3">
                    ...
                    <span>Complete Kerala Holiday Calendar 2026</span>
                    <i class="fas fa-star text-yellow-500"></i>
                </h2>
                <p class="text-lg text-gray-700 mb-4 leading-relaxed">
                    Welcome to the comprehensive Kerala Holiday Calendar 2026! This detailed guide provides you with all the important dates,
        ...
        <div class="mb-6 bg-white rounded-lg shadow-md p-4 border-l-4 border-green-500">
                ...
                <div class="flex items-center space-x-3">
                    <div class="relative">
                        ...
                        <select id="filterType"
                            ...
                            <option value="Kerala Festival">🌴 Kerala Festival</option>
                            <option value="Kerala Cultural">📚 Kerala Cultural</option>
            ...
            <div class="mt-4 text-center bg-gradient-to-r from-green-50 to-blue-50 p-3 rounded-lg border border-green-200">
                <p class="text-sm text-gray-700 flex items-center justify-center space-x-2">
                    ...
                    <span>💡 Search tips: Try searching for "Onam", "Vishu", "Pooram", or specific holiday names</span>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="grid grid-cols-7 bg-gradient-to-r from-gray-100 to-gray-200 border-b">
                ...
                $malayalam_weekdays = ['ഞായർ', 'തിങ്കൾ', 'ചൊവ്വ', 'ബുധൻ', 'വ്യാഴം', 'വെള്ളി', 'ശനി']; // Using English for simplicity, could use Malayalam if available
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg border border-blue-200 hover:shadow-md transition-all">
                        <div class="flex items-center justify-center space-x-2 mb-2">
                            ...
                            <div class="text-3xl font-bold text-blue-600"><?php echo count(array_filter($holidays_2026, function($h) { return $h['type'] === 'Kerala Festival'; })); ?></div>
                        </div>
            ...
            <div class="mt-6 p-4 bg-white rounded-lg border border-green-200">
                ...
                <div class="grid md:grid-cols-3 gap-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <ul class="text-xs text-green-600 space-y-1">
                            <li>• Kerala State Cooperative Bank</li>
                            ...
                            <li>• Foreign Banks (Branches in Kerala)</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What are the main festivals in Kerala in 2026?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            The main festivals in Kerala in 2026 include <strong>Onam</strong> (August 29) - the biggest harvest festival,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How many national holidays are there in Kerala 2026?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Kerala observes several national holidays in 2026 including <strong>Republic Day</strong> (January 26),
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Onam</strong> is the biggest and most important harvest festival of Kerala, celebrated with great enthusiasm in 2026 (August 29).
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Vishu</strong> (April 14, 2026) marks the Malayalam New Year and the beginning of the harvest season.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            ...
                            <strong>International Women's Day</strong> (March 8, 2026) are celebrated in Kerala, especially in
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Thrissur Pooram</strong> (May 13, 2026) is one of the most spectacular temple festivals in Kerala, held at the Vadakkunnathan Temple in Thrissur.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Labour Day / May Day</strong> (May 1, 2026) is a public holiday in Kerala. Banks, government offices,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Independence Day</strong> (August 15, 2026) is celebrated with great patriotic fervor in Kerala.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            Yes, <strong>Christmas</strong> (December 25, 2026) is celebrated with great enthusiasm in Kerala,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            <strong>International Women's Day</strong> (March 8, 2026) is celebrated across Kerala to recognize
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Are there any special holidays specific to Kerala in 2026?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
    ...
    <script>
        ...
        function downloadCalendar() {
            ...
            const content = `Kerala Holidays 2026
`;
            const blob = new Blob([content], { type: 'text/plain' });
            const url = window.URL.createObjectURL(blob);
            const a = document.createElement('a');
            a.href = url;
            a.download = 'kerala-holidays-2026.txt';
            a.click();
        ...
        function shareCalendar() {
            if (navigator.share) {
                navigator.share({
                    title: 'Kerala Holidays 2026',
                    text: 'Check out the Kerala holiday calendar for 2026!',
