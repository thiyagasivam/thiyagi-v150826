<?php include '../../header.php'; ?>
    <title>Madhya Pradesh Holidays 2026 | Complete Calendar | Festivals | National Holidays</title>
    <meta name="description" content="Complete Madhya Pradesh Holiday Calendar 2026. Find all major festivals, national holidays, cultural events, and religious celebrations in Madhya Pradesh. Plan your year with our comprehensive guide.">
    <meta name="keywords" content="Madhya Pradesh holidays 2026, MP festivals, Gwalior Dussehra, Ujjain Simhastha, Khajuraho Festival, national holidays India, cultural events MP, Madhya Pradesh calendar, holidays Madhya Pradesh, festival dates 2026">
    <meta name="author" content="Madhya Pradesh Holiday Calendar">
        <meta property="og:title" content="Madhya Pradesh Holidays 2026 - Complete Calendar">
    <meta property="og:description" content="Complete Madhya Pradesh Holiday Calendar 2026 with all festivals, national holidays, and cultural events. Plan your year with our comprehensive guide.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>">
    <meta property="og:image" content="https://via.placeholder.com/1200x630/228B22/FFFFFF?text=Madhya+Pradesh+Holidays+2026"> <!-- Forest Green -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Madhya Pradesh Holidays 2026">
    <meta name="twitter:description" content="Complete Madhya Pradesh Holiday Calendar 2026 with all festivals and holidays.">
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "WebPage",
        "name": "Madhya Pradesh Holidays 2026",
        "description": "Complete Madhya Pradesh Holiday Calendar 2026 with all festivals, national holidays, and cultural events",
        ...
        "mainEntity": {
            ...
            "mainEntity": [
                {
                    "@type": "Question",
                    "name": "What are the main festivals in Madhya Pradesh in 2026?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "The main festivals in Madhya Pradesh in 2026 include Gwalior Dussehra (October 1-10), Ujjain Simhastha/Kumbh Mela (May 11-June 9), and Khajuraho Dance Festival (February 20-28)."
                    }
                },
                {
                    "@type": "Question",
                    "name": "How many national holidays are there in Madhya Pradesh 2026?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "There are several national holidays in Madhya Pradesh 2026 including Republic Day (January 26), Independence Day (August 15), and Gandhi Jayanti (October 2)."
                    }
                },
                {
                    "@type": "Question",
                    "name": "What is Gwalior Dussehra and why is it important?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Gwalior Dussehra is one of the longest Dussehra celebrations in India, lasting 10 days in October. It's held in honor of Lord Rama's victory over Ravana and features elaborate Ramlila performances and a grand parade."
                    }
                },
                {
                    "@type": "Question",
                    "name": "How is Independence Day celebrated in Madhya Pradesh?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Independence Day (August 15, 2026) is celebrated with great patriotic fervor in Madhya Pradesh. The day begins with flag hoisting ceremonies in schools, colleges, and government offices, often accompanied by cultural programs."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Are there any special holidays specific to Madhya Pradesh in 2026?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Yes, Madhya Pradesh has several state-specific holidays and festivals. Gwalior Dussehra, Ujjain Simhastha, and Makar Sankranti are major celebrations unique to the state and often observed as state holidays or widely celebrated events."
                    }
                }
            ]
        },
        "publisher": {
            "@type": "Organization",
            "name": "Madhya Pradesh Holiday Calendar"
        },
    ...
    <script>
        tailwind.config = {
            theme: {
                extend: {
                    colors: {
                        'mp-green': '#228B22', // Forest Green
                        'mp-blue': '#1E90FF',   // Dodger Blue
                        'mp-orange': '#FF8C00', // Dark Orange
                        'mp-purple': '#9370DB'  // Medium Purple
                    }
                }
            }
        }
...
<body class="bg-gradient-to-br from-blue-50 to-green-100 min-h-screen">
    <?php
    // Madhya Pradesh Holidays 2026 Data
    // Note: Dates for Simhastha and some festivals are estimates based on typical timing. Exact dates may vary.
    $holidays_2026 = [
        '2026-01-01' => [
            'name' => 'New Year\'s Day',
        ...
        '2026-02-20' => [ // Khajuraho Dance Festival start - Approximate date
            'name' => 'Khajuraho Dance Festival (Start)',
            'type' => 'MP Festival',
            'description' => 'Classical dance performances at Khajuraho Temples',
            'icon' => 'fa-music',
            'bank_holiday' => false // Typically not a state holiday, but culturally significant
        ],
        '2026-02-28' => [ // Khajuraho Dance Festival end - Approximate date
            'name' => 'Khajuraho Dance Festival (End)',
            'type' => 'MP Festival',
            'description' => 'Final day of classical dance performances',
            'icon' => 'fa-music',
            'bank_holiday' => false
        ],
        '2026-03-08' => [
        ...
        '2026-03-29' => [ // Holi - Approximate date
            ...
            'bank_holiday' => true // Commonly observed as a holiday
        ],
        '2026-04-14' => [
        ...
        '2026-05-11' => [ // Ujjain Simhastha start - Approximate date (May-June)
            'name' => 'Ujjain Simhastha (Start)',
            'type' => 'MP Festival',
            'description' => 'Kumbh Mela in Ujjain - Start Date',
            'icon' => 'fa-water',
            'bank_holiday' => true // Major festival
        ],
        '2026-06-09' => [ // Ujjain Simhastha end - Approximate date
            'name' => 'Ujjain Simhastha (End)',
            'type' => 'MP Festival',
            'description' => 'Kumbh Mela in Ujjain - End Date',
            'icon' => 'fa-water',
            'bank_holiday' => false // End date might not be a holiday
        ],
        ...
        '2026-10-01' => [ // Gwalior Dussehra start - Approximate date (October)
            'name' => 'Gwalior Dussehra (Start)',
            'type' => 'MP Festival',
            'description' => '10-day Dussehra celebration in Gwalior - Start',
            'icon' => 'fa-dragon',
            'bank_holiday' => true // Major festival
        ],
        '2026-10-10' => [ // Gwalior Dussehra end - Approximate date
            'name' => 'Gwalior Dussehra (End)',
            'type' => 'MP Festival',
            'description' => '10-day Dussehra celebration in Gwalior - End',
            'icon' => 'fa-dragon',
            'bank_holiday' => true
        ],
    ...
    $bank_holidays_2026 = [
        ...
        '2026-09-24' => [ // Vijaya Dashami/Dussehra - Approximate date (General)
    ...
    ?>
    <!-- Header -->
    <header class="bg-gradient-to-r from-mp-green to-mp-blue text-white shadow-lg relative overflow-hidden">
        <!-- Background Pattern -->
        ...
        <div class="container mx-auto px-4 py-6 relative z-10">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-4xl font-bold flex items-center space-x-3">
                            <span>Madhya Pradesh Holidays 2026</span>
                            <i class="fas fa-tree text-2xl animate-bounce"></i> <!-- Tree icon for MP -->
                        </h1>
                        <p class="text-lg opacity-90 flex items-center space-x-2">
                            <i class="fas fa-map-marker-alt text-green-200"></i>
                            <span>मध्य प्रदेश छुट्टी के दिन</span> <!-- Hindi -->
                        </p>
                    </div>
                </div>
            ...
            <div class="flex justify-center mt-6 space-x-8 opacity-60">
                ...
                <i class="fas fa-tree text-2xl text-green-200"></i> <!-- Tree -->
                <i class="fas fa-star text-2xl text-yellow-200"></i>
                <i class="fas fa-heart text-2xl text-red-200"></i>
                <i class="fas fa-music text-2xl text-purple-200"></i> <!-- Music -->
                <i class="fas fa-dragon text-2xl text-orange-200"></i> <!-- Dragon for Dussehra -->
            </div>
        </div>
    </header>
    <!-- Main Content -->
    <main class="container mx-auto px-4 py-8">
        ...
        <nav class="mb-6 text-sm text-gray-600" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-2">
                ...
                <li><i class="fas fa-chevron-right text-xs"></i></li>
                <li><a href="#" class="hover:text-blue-600 transition-colors">Madhya Pradesh</a></li>
                <li><i class="fas fa-chevron-right text-xs"></i></li>
        ...
        <section class="mb-8 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg p-6 border-l-4 border-blue-500">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl font-bold text-gray-800 mb-4 flex items-center justify-center space-x-3">
                    ...
                    <span>Complete Madhya Pradesh Holiday Calendar 2026</span>
                    <i class="fas fa-star text-yellow-500"></i>
                </h2>
                <p class="text-lg text-gray-700 mb-4 leading-relaxed">
                    Welcome to the comprehensive Madhya Pradesh Holiday Calendar 2026! This detailed guide provides you with all the important dates,
                    festivals, and celebrations throughout the year. Whether you're planning a trip to the heart of India, organizing events,
                ...
                <div class="grid md:grid-cols-3 gap-4 mt-6">
                    <div class="bg-white p-4 rounded-lg shadow-sm border border-blue-200">
                        <i class="fas fa-tree text-2xl text-green-500 mb-2"></i> <!-- Tree icon -->
                        <h3 class="font-semibold text-gray-800 mb-2">MP Festivals</h3>
                        <p class="text-sm text-gray-600">Unique celebrations like Dussehra, Simhastha, and cultural events</p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-sm border border-blue-200">
        ...
        <div class="mb-6 bg-white rounded-lg shadow-md p-4 border-l-4 border-blue-500">
                ...
                <div class="flex-1 w-full md:w-96">
                    <div class="relative">
                        ...
                        <div id="searchSuggestions" class="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg hidden">
                            ...
                            <div class="p-2">
                                <button onclick="quickSearch('Dussehra')" class="block w-full text-left px-3 py-2 hover:bg-blue-50 rounded text-sm flex items-center space-x-2">
                                    <i class="fas fa-dragon text-orange-500"></i> <!-- Dragon icon -->
                                    <span>Dussehra</span>
                                </button>
                                <button onclick="quickSearch('Simhastha')" class="block w-full text-left px-3 py-2 hover:bg-blue-50 rounded text-sm flex items-center space-x-2">
                                    <i class="fas fa-water text-blue-500"></i> <!-- Water icon -->
                                    <span>Simhastha</span>
                                </button>
                                <button onclick="quickSearch('Khajuraho')" class="block w-full text-left px-3 py-2 hover:bg-blue-50 rounded text-sm flex items-center space-x-2">
                                    <i class="fas fa-monument text-purple-500"></i> <!-- Monument icon -->
                                    <span>Khajuraho</span>
                                </button>
                ...
                <div class="flex items-center space-x-3">
                    <div class="relative">
                        ...
                        <select id="filterType"
                            ...
                            <option value="MP Festival">🌳 MP Festival</option> <!-- Tree icon -->
            ...
            <div class="mt-4 text-center bg-gradient-to-r from-blue-50 to-green-50 p-3 rounded-lg border border-blue-200">
                <p class="text-sm text-gray-700 flex items-center justify-center space-x-2">
                    ...
                    <span>💡 Search tips: Try searching for "Dussehra", "Simhastha", "Khajuraho", or specific holiday names</span>
                ...
                <div class="flex items-center justify-center space-x-3 mb-2">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 flex items-center justify-center space-x-2">
                            ...
                            <span>MP Month: <?php echo $month_names[$current_month]; ?></span>
                        </p>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="grid grid-cols-7 bg-gradient-to-r from-gray-100 to-gray-200 border-b">
                ...
                $hindi_weekdays = ['रवि', 'सोम', 'मंगल', 'बुध', 'गुरु', 'शुक्र', 'शनि']; // Hindi transliteration
            ...
            <div class="grid grid-cols-7">
                ...
                for ($day = 1; $day <= $days_in_month; $day++) {
                    ...
                    if ($is_bank_holiday) {
                        ...
                        $cell_classes .= ' bg-green-50'; // Changed color for MP
                    }
                    echo '<div class="' . $cell_classes . '">';
                    echo '<div class="text-lg font-semibold text-gray-800 mb-2">' . $day . '</div>';
                    if ($is_holiday) {
                        $holiday = $all_holidays_2026[$date];
                        $border_color = $is_bank_holiday ? 'border-blue-500' : 'border-green-500'; // Changed color for MP
                        $bg_color = $is_bank_holiday ? 'bg-blue-100' : 'bg-green-100'; // Changed color for MP
                        $text_color = $is_bank_holiday ? 'text-blue-800' : 'text-green-800'; // Changed color for MP
                        $desc_color = $is_bank_holiday ? 'text-blue-700' : 'text-green-700'; // Changed color for MP
                        ...
                        echo '<i class="fas ' . $holiday['icon'] . ' text-lg ' . ($is_bank_holiday ? 'text-blue-600' : 'text-green-600') . '"></i>'; // Changed color for MP
                        ...
                        echo '<i class="fas fa-tag ' . ($is_bank_holiday ? 'text-blue-500' : 'text-green-500') . '"></i>'; // Changed color for MP
        ...
        <div class="mt-8 grid md:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 border-l-4 border-green-500">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="text-center p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-lg border border-green-200 hover:shadow-md transition-all"> <!-- Changed color -->
                        <div class="flex items-center justify-center space-x-2 mb-2">
                            <i class="fas fa-tree text-green-600 text-xl"></i> <!-- Tree icon -->
                            <div class="text-3xl font-bold text-green-600"><?php echo count(array_filter($holidays_2026, function($h) { return $h['type'] === 'MP Festival'; })); ?></div>
                        </div>
                        <div class="text-sm text-green-700 font-medium">MP Festivals</div> <!-- Changed text -->
                        <div class="text-xs text-green-600 mt-1">🌳 Cultural</div> <!-- Changed text -->
                    </div>
        ...
        <div class="mt-8 bg-white rounded-lg shadow-lg p-6 border-l-4 border-blue-500">
            ...
            <p class="text-gray-600 mb-6">All major banks in Madhya Pradesh will be closed on these dates. Plan your banking activities accordingly.</p>
            ...
            <div class="mt-6 p-4 bg-white rounded-lg border border-blue-200">
                ...
                <div class="grid md:grid-cols-3 gap-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <ul class="text-xs text-blue-600 space-y-1">
                            <li>• Madhya Pradesh State Cooperative Bank</li>
                            ...
                            <li>• Foreign Banks (Branches in MP)</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            <i class="fas fa-dragon text-orange-500"></i> <!-- Dragon icon -->
                            <span>What are the main festivals in Madhya Pradesh in 2026?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            The main festivals in Madhya Pradesh in 2026 include <strong>Gwalior Dussehra</strong> (October 1-10) - a 10-day grand celebration,
                            <strong>Ujjain Simhastha/Kumbh Mela</strong> (May 11-June 9) - a major religious gathering, and
                            <strong>Khajuraho Dance Festival</strong> (February 20-28) - showcasing classical Indian dance at ancient temples.
                        </p>
                    </div>
                    <!-- FAQ Item 2 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How many national holidays are there in Madhya Pradesh 2026?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Madhya Pradesh observes several national holidays in 2026 including <strong>Republic Day</strong> (January 26),
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            <i class="fas fa-dragon text-orange-500"></i> <!-- Dragon icon -->
                            <span>What is Gwalior Dussehra and why is it important?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Gwalior Dussehra</strong> is one of the longest Dussehra celebrations in India, held in Gwalior for 10 days (around October).
                            It commemorates Lord Rama's victory over Ravana. The festival is famous for its elaborate <em>Ramlila</em> performances,
                            cultural programs, and a grand parade featuring floats and tableaux depicting scenes from the Ramayana.
                        </p>
                    </div>
                    <!-- FAQ Item 4 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            <i class="fas fa-water text-blue-500"></i> <!-- Water icon -->
                            <span>What is Ujjain Simhastha and its significance?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Ujjain Simhastha</strong> (May-June 2026) is one of the four <em>Kumbh Melas</em> held in India, occurring in Ujjain.
                            It's a major Hindu religious gathering that takes place when Jupiter enters Leo and the Sun is in Aries.
                            Millions of devotees take a holy dip in the Shipra River, believing it will cleanse their sins and lead to salvation.
                        </p>
                    </div>
                    <!-- FAQ Item 5 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Are international holidays like Valentine's Day celebrated in Madhya Pradesh?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Yes, <strong>Valentine's Day</strong> (February 14, 2026) and other international holidays like
                            <strong>International Women's Day</strong> (March 8, 2026) are celebrated in Madhya Pradesh, especially in
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            <i class="fas fa-sun text-yellow-500"></i> <!-- Sun icon -->
                            <span>What is Makar Sankranti and how is it celebrated?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Makar Sankranti</strong> (January 14, 2026) marks the sun's transition into the zodiac sign of Capricorn (Makar).
                            In Madhya Pradesh, it's celebrated with kite flying, preparing special dishes like til-gul ladoo (sesame-jaggery sweets),
                            and taking holy dips in rivers. It signifies the end of winter and the beginning of longer days.
                        </p>
                    </div>
                    <!-- FAQ Item 7 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Is Labour Day a public holiday in Madhya Pradesh?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Labour Day / May Day</strong> (May 1, 2026) is a public holiday in Madhya Pradesh. Banks, government offices,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How is Independence Day celebrated in Madhya Pradesh?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Independence Day</strong> (August 15, 2026) is celebrated with great patriotic fervor in Madhya Pradesh.
                            ...
                            The main celebration usually takes place at the Raj Bhavan in Bhopal.
                        </p>
                    </div>
                    <!-- FAQ Item 9 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What is the significance of Gandhi Jayanti in Madhya Pradesh?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Gandhi Jayanti</strong> (October 2, 2026) commemorates the birth anniversary of Mahatma Gandhi,
                            the Father of the Nation. In Madhya Pradesh, this day is observed with prayer meetings, seminars on Gandhian
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How is Children's Day celebrated in Madhya Pradesh?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Children's Day</strong> (November 14, 2026) celebrates the birth anniversary of India's first
                            Prime Minister, Jawaharlal Nehru. In Madhya Pradesh, schools organize special programs, cultural activities, and competitions for children.
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            <i class="fas fa-star text-yellow-500"></i>
                            <span>Is Christmas celebrated in Madhya Pradesh?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Yes, <strong>Christmas</strong> (December 25, 2026) is celebrated with enthusiasm in Madhya Pradesh,
                            especially in areas with significant Christian populations like Indore and Bhopal. Churches are beautifully decorated,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What is the significance of International Women's Day in Madhya Pradesh?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>International Women's Day</strong> (March 8, 2026) is celebrated across Madhya Pradesh to recognize
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How far in advance should I plan for Madhya Pradesh festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            For major festivals like <strong>Gwalior Dussehra</strong> and <strong>Ujjain Simhastha</strong>, it's recommended to
                            plan at least 3-6 months in advance, especially if you're planning to travel to Madhya Pradesh. These festivals
                            attract millions of visitors, so accommodations and transportation should be booked very early. For smaller celebrations,
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Which cities in Madhya Pradesh are best for experiencing festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            <strong>Bhopal</strong> (capital city) hosts major official celebrations. <strong>Gwalior</strong> is famous for its grand Dussehra.
                            <strong>Ujjain</strong> is the site of the Simhastha Kumbh Mela. <strong>Khajuraho</strong> hosts the famous dance festival.
                            <strong>Indore</strong> and <strong>Jabalpur</strong> also have vibrant local celebrations for various festivals.
                        </p>
                    </div>
                    <!-- FAQ Item 15 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>Are there any special holidays specific to Madhya Pradesh in 2026?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Yes, Madhya Pradesh has several state-specific holidays and festivals. <strong>Gwalior Dussehra</strong>,
                            <strong>Ujjain Simhastha</strong>, and <strong>Makar Sankranti</strong> are major celebrations unique to Madhya Pradesh
                            and are widely celebrated. The state government may also declare additional holidays for local events or administrative reasons.
                        </p>
                    </div>
                    <!-- FAQ Item 16 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What traditional foods are associated with Madhya Pradesh festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Madhya Pradesh festivals feature a variety of traditional foods. During <strong>Makar Sankranti</strong>, people prepare
                            <em>til-gul ladoo</em> (sesame-jaggery sweets). <strong>Dussehra</strong> sees the preparation of festive snacks and sweets.
                            During <strong>Diwali</strong>, special sweets like <em>namkeen</em>, <em>peda</em>, and <em>malpua</em> are popular.
                            The state is also known for its <em>poha</em>, <em>jalebi</em>, and <em>bafla</em> which are enjoyed year-round and during festivals.
                        </p>
                    </div>
                    <!-- FAQ Item 17 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>What cultural activities are organized during Madhya Pradesh festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Madhya Pradesh festivals feature rich cultural activities including classical music concerts, traditional folk dances
                            (like <em>Bundeli</em> and <em>Malwa</em> dances), <em>Ramlila</em> performances, and cultural competitions.
                            <strong>Gwalior Dussehra</strong> includes elaborate parades and floats. <strong>Khajuraho Dance Festival</strong>
                            showcases classical Indian dance forms like Bharatanatyam and Kathak. Many festivals also feature
                            traditional craft exhibitions and cultural workshops for visitors.
                        </p>
                    </div>
                    <!-- FAQ Item 18 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        <h3 class="text-xl font-semibold text-gray-800 mb-3 flex items-center space-x-2">
                            ...
                            <span>How can tourists participate in Madhya Pradesh festivals?</span>
                        </h3>
                        <p class="text-gray-700 leading-relaxed">
                            Tourists can participate in Madhya Pradesh festivals by attending public celebrations, visiting temples or venues during
                            ...
                            and participate in cultural activities. Learning basic greetings in Hindi can enhance the experience.
                        </p>
                    </div>
                    <!-- FAQ Item 19 -->
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            Photography and videography are generally allowed during most Madhya Pradesh festivals, but it's important to
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                        ...
                        <p class="text-gray-700 leading-relaxed">
                            For detailed information about Madhya Pradesh festivals, you can visit the official Madhya Pradesh Tourism website,
                            contact local tourism offices, or check with local temples, cultural organizations, and event organizers.
    ...
    <script>
        ...
        function downloadCalendar() {
            ...
            const content = `Madhya Pradesh Holidays 2026
`;
            const blob = new Blob([content], { type: 'text/plain' });
            const url = window.URL.createObjectURL(blob);
            const a = document.createElement('a');
            a.href = url;
            a.download = 'madhya-pradesh-holidays-2026.txt';
            a.click();
        ...
        function shareCalendar() {
            if (navigator.share) {
                navigator.share({
                    title: 'Madhya Pradesh Holidays 2026',
                    text: 'Check out the Madhya Pradesh holiday calendar for 2026!',
