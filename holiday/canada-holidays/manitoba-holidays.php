...
.bg-mb-red { background-color: var(--mb-red); }
.text-mb-red { color: var(--mb-red); }
.border-mb-red { border-color: var(--mb-red); }
</style>
...
<nav class="bg-white shadow-sm border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center space-x-2 py-3 text-sm">
            ...
            <span class="text-gray-500">/</span>
            <span class="text-gray-900 font-medium">Manitoba Holidays 2026</span>
        </div>
    </div>
</nav>
...
<main class="container mx-auto px-4 py-8">
    <header class="mb-8">
        <h1 class="text-4xl font-bold text-center text-mb-red flex items-center justify-center gap-3">
            <i class="fas fa-wheat-awn text-yellow-600"></i>
            Manitoba Holidays 2026
            <i class="fas fa-calendar-days text-mb-red"></i>
        </h1>
        <p class="text-center text-lg text-gray-700 mt-2">Provincial and Federal Holiday Calendar for Manitoba, Canada</p>
    </header>

    <section class="mb-10">
        <div class="bg-white rounded-lg shadow-lg p-6 border-l-4 border-mb-red">
            <h2 class="text-2xl font-bold text-mb-red mb-4 flex items-center gap-2">
                <i class="fas fa-flag"></i>
                Manitoba Provincial Holidays 2026
            </h2>
            <div class="grid md:grid-cols-2 gap-4">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    <h3 class="font-semibold text-lg mb-2">Louis Riel Day</h3>
                    <p class="text-gray-600">February 17, 2026 (Monday)</p>
                    <p class="text-sm text-gray-500 mt-1">Manitoba provincial holiday</p>
                </div>
                <div class="bg-gray-50 p-4 rounded-lg">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    <h3 class="font-semibold text-lg mb-2">Terry Fox Day</h3>
                    <p class="text-gray-600">August 4, 2026 (Monday)</p>
                    <p class="text-sm text-gray-500 mt-1">Manitoba civic holiday</p>
                </div>
                <div class="bg-gray-50 p-4 rounded-lg">
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="mb-6 bg-white rounded-lg p-6 border border-green-200 shadow-sm">
                ...
                <p class="text-gray-700 leading-relaxed">
                    Banks in Manitoba are typically closed on federal statutory holidays and provincial holidays. ATMs and online banking services remain available 24/7. 
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-4 bg-orange-50 rounded-lg border border-orange-100 hover:shadow-md transition-all">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <div class="font-semibold text-gray-800">Louis Riel Day</div>
                        ...
                        <div class="flex items-center justify-between p-4 bg-orange-50 rounded-lg border border-orange-100 hover:shadow-md transition-all">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <div class="font-semibold text-gray-800">Terry Fox Day</div>
    ...
    <!-- FAQ Section -->
    <section class="mt-12 bg-white rounded-lg shadow-lg p-8 border-l-4 border-manitoba-blue">
        <div class="max-w-4xl mx-auto">
            <h2 class="text-3xl font-bold text-gray-800 mb-8 text-center flex items-center justify-center space-x-3">
                <i class="fas fa-question-circle text-manitoba-blue"></i>
                <span>Frequently Asked Questions</span>
                <i class="fas fa-lightbulb text-yellow-500"></i>
            </h2>
            <div class="space-y-6">
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">What are the main statutory holidays in Manitoba 2026?</h3>
                    <p class="text-gray-700 leading-relaxed">Manitoba observes all federal statutory holidays plus two provincial holidays: Louis Riel Day and Terry Fox Day.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">Are Manitoba provincial holidays different from other provinces?</h3>
                    <p class="text-gray-700 leading-relaxed">Manitoba follows all federal statutory holidays and adds Louis Riel Day (third Monday in February) and Terry Fox Day (first Monday in August).</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">Who was Louis Riel and why does Manitoba celebrate Louis Riel Day?</h3>
                    <p class="text-gray-700 leading-relaxed">Louis Riel was a Métis leader who played a pivotal role in Manitoba's entry into Confederation. Louis Riel Day honors his contributions to Manitoba's history and the rights of the Métis people.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">Are schools and banks closed on statutory holidays in Manitoba?</h3>
                ...
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">What is Terry Fox Day?</h3>
                    <p class="text-gray-700 leading-relaxed">Terry Fox Day is Manitoba's civic holiday observed on the first Monday in August, honoring Terry Fox's Marathon of Hope and his fight against cancer.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">Do all employers have to give paid time off for statutory holidays in Manitoba?</h3>
                    <p class="text-gray-700 leading-relaxed">Under Manitoba's Employment Standards Code, eligible employees are entitled to general holiday pay for statutory holidays. Specific rules apply based on employment terms and length of service.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">What happens if a statutory holiday falls on a weekend in Manitoba?</h3>
                ...
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">Is Truth and Reconciliation Day observed in Manitoba?</h3>
                    <p class="text-gray-700 leading-relaxed">Yes, Truth and Reconciliation Day (September 30) is a federal statutory holiday observed in Manitoba since 2021, honoring survivors of residential schools.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">Are there any municipal holidays in Manitoba cities?</h3>
                    <p class="text-gray-700 leading-relaxed">Some municipalities may observe additional local holidays or events. Check your city or municipal government website for information on local observances in Manitoba.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">How do I know if I'm entitled to statutory holiday pay in Manitoba?</h3>
                    <p class="text-gray-700 leading-relaxed">Under the Employment Standards Code, employees who have worked for 30 days and meet certain criteria are entitled to general holiday pay. Check with Employment Standards Manitoba for details.</p>
                </div>
            </div>
        </div>
    </section>
