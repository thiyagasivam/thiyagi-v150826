...
.bg-alberta-blue { background-color: var(--alberta-blue); }
.text-alberta-blue { color: var(--alberta-blue); }
.border-alberta-blue { border-color: var(--alberta-blue); }
</style>
...
<nav class="bg-white shadow-sm border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center space-x-2 py-3 text-sm">
            ...
            <span class="text-gray-500">/</span>
            <span class="text-gray-900 font-medium">Alberta Holidays 2026</span>
        </div>
    </div>
</nav>
...
<main class="container mx-auto px-4 py-8">
    <header class="mb-8">
        <h1 class="text-4xl font-bold text-center text-alberta-blue flex items-center justify-center gap-3">
            <i class="fas fa-mountain text-gray-600"></i>
            Alberta Holidays 2026
            <i class="fas fa-calendar-days text-red-500"></i>
        </h1>
        <p class="text-center text-lg text-gray-700 mt-2">Provincial and Federal Holiday Calendar for Alberta, Canada</p>
    </header>

    <section class="mb-10">
        <div class="bg-white rounded-lg shadow-lg p-6 border-l-4 border-alberta-blue">
            <h2 class="text-2xl font-bold text-alberta-blue mb-4 flex items-center gap-2">
                <i class="fas fa-flag"></i>
                Alberta Provincial Holidays 2026
            </h2>
            <div class="grid md:grid-cols-2 gap-4">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p class="text-sm text-gray-500 mt-1">Alberta provincial holiday</p>
                </div>
                <div class="bg-gray-50 p-4 rounded-lg">
    ...
    <section class="mb-10">
        <div class="bg-white rounded-lg shadow-lg p-6 border-l-4 border-orange-500">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    <h3 class="font-semibold text-lg mb-2">Employment Standards</h3>
                    <p class="text-gray-600 text-sm">
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="mb-6 bg-white rounded-lg p-6 border border-green-200 shadow-sm">
                ...
                <p class="text-gray-700 leading-relaxed">
                    Banks in Alberta are typically closed on federal statutory holidays and provincial holidays. ATMs and online banking services remain available 24/7. 
    ...
    <!-- FAQ Section -->
    <section class="mt-12 bg-white rounded-lg shadow-lg p-8 border-l-4 border-alberta-blue">
        <div class="max-w-4xl mx-auto">
            <h2 class="text-3xl font-bold text-gray-800 mb-8 text-center flex items-center justify-center space-x-3">
                <i class="fas fa-question-circle text-alberta-blue"></i>
                <span>Frequently Asked Questions</span>
                <i class="fas fa-lightbulb text-yellow-500"></i>
            </h2>
            <div class="space-y-6">
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">What are the main statutory holidays in Alberta 2026?</h3>
                    <p class="text-gray-700 leading-relaxed">Alberta observes all federal statutory holidays plus two provincial holidays: Family Day and Heritage Day.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">Are Alberta provincial holidays different from federal holidays?</h3>
                    <p class="text-gray-700 leading-relaxed">Alberta follows all federal statutory holidays and adds two provincial holidays: Family Day (third Monday in February) and Heritage Day (first Monday in August).</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">Is Truth and Reconciliation Day a statutory holiday in Alberta?</h3>
                    <p class="text-gray-700 leading-relaxed">Yes, Truth and Reconciliation Day (September 30) is a federal statutory holiday observed in Alberta since 2021.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">Are schools and banks closed on statutory holidays in Alberta?</h3>
                ...
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">What is Heritage Day in Alberta?</h3>
                    <p class="text-gray-700 leading-relaxed">Heritage Day celebrates Alberta's diverse cultural heritage and is observed on the first Monday in August. It's a provincial statutory holiday unique to Alberta.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">Do all employers have to give paid time off for statutory holidays in Alberta?</h3>
                    <p class="text-gray-700 leading-relaxed">Under Alberta's Employment Standards Code, employees are entitled to general holiday pay for statutory holidays, whether they work or not. Specific rules apply based on employment terms.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">What happens if a statutory holiday falls on a weekend in Alberta?</h3>
                    <p class="text-gray-700 leading-relaxed">If a statutory holiday falls on a Saturday, it is observed on the preceding Friday. If it falls on a Sunday, it is observed on the following Monday.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">Is Family Day celebrated differently in Alberta?</h3>
                    <p class="text-gray-700 leading-relaxed">Alberta was the first province to introduce Family Day in 1990, observed on the third Monday in February. Other provinces have since adopted similar holidays.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">Are there any municipal holidays in Alberta cities?</h3>
                    <p class="text-gray-700 leading-relaxed">Some municipalities may observe additional local holidays or events. Check your city or municipal government website for information on local observances.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">How do I know if I'm entitled to statutory holiday pay in Alberta?</h3>
                    <p class="text-gray-700 leading-relaxed">Under the Employment Standards Code, most employees who have worked for 30 days are entitled to general holiday pay. Check with Alberta Employment Standards for specific details.</p>
                </div>
            </div>
        </div>
    </section>
