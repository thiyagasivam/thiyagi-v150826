...
.bg-ontario-blue { background-color: var(--ontario-blue); }
.text-ontario-blue { color: var(--ontario-blue); }
.border-ontario-blue { border-color: var(--ontario-blue); }
</style>
...
<nav class="bg-white shadow-sm border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center space-x-2 py-3 text-sm">
            ...
            <span class="text-gray-500">/</span>
            <span class="text-gray-900 font-medium">Ontario Holidays 2026</span>
        </div>
    </div>
</nav>
...
<main class="container mx-auto px-4 py-8">
    <header class="mb-8">
        <h1 class="text-4xl font-bold text-center text-ontario-blue flex items-center justify-center gap-3">
            <i class="fas fa-maple-leaf text-ontario-blue"></i>
            Ontario Holidays 2026
            <i class="fas fa-calendar-days text-red-500"></i>
        </h1>
        <p class="text-center text-lg text-gray-700 mt-2">Provincial and Federal Holiday Calendar for Ontario, Canada</p>
    </header>

    <section class="mb-10">
        <div class="bg-white rounded-lg shadow-lg p-6 border-l-4 border-ontario-blue">
            <h2 class="text-2xl font-bold text-ontario-blue mb-4 flex items-center gap-2">
                <i class="fas fa-flag"></i>
                Ontario Provincial Holidays 2026
            </h2>
            <div class="grid md:grid-cols-2 gap-4">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p class="text-sm text-gray-500 mt-1">Ontario provincial holiday</p>
                </div>
                <div class="bg-gray-50 p-4 rounded-lg">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    <h3 class="font-semibold text-lg mb-2">Civic Holiday</h3>
    ...
    <section class="mb-10">
        <div class="bg-white rounded-lg shadow-lg p-6 border-l-4 border-green-500">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    <h3 class="font-semibold text-lg mb-2">Statutory Holiday Pay</h3>
                ...
                <div>
                    <h3 class="font-semibold text-lg mb-2">Provincial Specific</h3>
                    <p class="text-gray-600 text-sm">
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="mb-6 bg-white rounded-lg p-6 border border-green-200 shadow-sm">
                ...
                <p class="text-gray-700 leading-relaxed">
                    Banks in Ontario are typically closed on federal statutory holidays and provincial holidays. ATMs and online banking services remain available 24/7. 
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between p-4 bg-orange-50 rounded-lg border border-orange-100 hover:shadow-md transition-all">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <div class="font-semibold text-gray-800">Civic Holiday</div>
    ...
    <!-- FAQ Section -->
    <section class="mt-12 bg-white rounded-lg shadow-lg p-8 border-l-4 border-ontario-blue">
        <div class="max-w-4xl mx-auto">
            <h2 class="text-3xl font-bold text-gray-800 mb-8 text-center flex items-center justify-center space-x-3">
                <i class="fas fa-question-circle text-ontario-blue"></i>
                <span>Frequently Asked Questions</span>
                <i class="fas fa-lightbulb text-yellow-500"></i>
            </h2>
            <div class="space-y-6">
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">What are the main statutory holidays in Ontario 2026?</h3>
                    <p class="text-gray-700 leading-relaxed">Ontario observes all federal statutory holidays plus two provincial holidays: Family Day and Civic Holiday.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">Are Ontario provincial holidays different from other provinces?</h3>
                    <p class="text-gray-700 leading-relaxed">Ontario follows all federal statutory holidays and adds Family Day (third Monday in February) and Civic Holiday (first Monday in August).</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">Is Truth and Reconciliation Day a statutory holiday in Ontario?</h3>
                    <p class="text-gray-700 leading-relaxed">Yes, Truth and Reconciliation Day (September 30) is a federal statutory holiday observed in Ontario since 2021, honoring survivors of residential schools.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">Are schools and banks closed on statutory holidays in Ontario?</h3>
                ...
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">What is Civic Holiday in Ontario?</h3>
                    <p class="text-gray-700 leading-relaxed">Civic Holiday is a provincial statutory holiday observed on the first Monday in August. Different municipalities may call it by different names like Simcoe Day in Toronto.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">Do all employers have to give paid time off for statutory holidays in Ontario?</h3>
                    <p class="text-gray-700 leading-relaxed">Under Ontario's Employment Standards Act, eligible employees are entitled to public holiday pay for statutory holidays. Specific rules apply based on employment terms and length of service.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">What happens if a statutory holiday falls on a weekend in Ontario?</h3>
                    <p class="text-gray-700 leading-relaxed">If a statutory holiday falls on a non-working day, the holiday is substituted to the next working day. Specific rules may vary by employer and collective agreements.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">Is Family Day celebrated differently in Ontario?</h3>
                    <p class="text-gray-700 leading-relaxed">Ontario introduced Family Day in 2008, observed on the third Monday in February. It's similar to other provinces' Family Day but Ontario was not the first to introduce it.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">Are there any municipal holidays in Ontario cities?</h3>
                    <p class="text-gray-700 leading-relaxed">Some municipalities may observe additional local holidays or have different names for Civic Holiday. Check your city or municipal government website for local observances.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">How do I know if I'm entitled to statutory holiday pay in Ontario?</h3>
                    <p class="text-gray-700 leading-relaxed">Under the Employment Standards Act, employees who have worked for 30 days and meet certain criteria are entitled to public holiday pay. Check with Employment Standards Ontario for details.</p>
                </div>
            </div>
        </div>
    </section>
