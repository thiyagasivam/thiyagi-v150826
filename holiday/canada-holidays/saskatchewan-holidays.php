...
.bg-sk-green { background-color: var(--sk-green); }
.text-sk-green { color: var(--sk-green); }
.border-sk-green { border-color: var(--sk-green); }
</style>
...
<main class="container mx-auto px-4 py-8">
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="mb-6 bg-white rounded-lg p-6 border border-green-200 shadow-sm">
                ...
                <p class="text-gray-700 leading-relaxed">
                    Banks in Saskatchewan are typically closed on federal statutory holidays and Saskatchewan Day. ATMs and online banking services remain available 24/7. 
                    Always check with your specific bank for their holiday schedule as service availability may vary.
                </p>
            </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 border border-orange-200">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-4 bg-orange-50 rounded-lg border border-orange-100 hover:shadow-md transition-all">
                            <div class="flex items-center space-x-3">
                                <div class="bg-orange-100 rounded-full p-2">
                                    <i class="fas fa-wheat text-orange-600"></i>
                                </div>
                                <div>
                        ...
                        <div class="flex items-center justify-between p-4 bg-orange-50 rounded-lg border border-orange-100 hover:shadow-md transition-all">
                            <div class="flex items-center space-x-3">
                                <div class="bg-orange-100 rounded-full p-2">
                                    <i class="fas fa-turkey text-orange-600"></i>
                                </div>
                                <div>
    ...
    <!-- FAQ Section -->
    <section class="mt-12 bg-white rounded-lg shadow-lg p-8 border-l-4 border-sk-green">
        <div class="max-w-4xl mx-auto">
            <h2 class="text-3xl font-bold text-gray-800 mb-8 text-center flex items-center justify-center space-x-3">
                <i class="fas fa-question-circle text-sk-green"></i>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    ...
                    <p class="text-gray-700 leading-relaxed">Yes, Remembrance Day (November 11) is a statutory holiday in Saskatchewan. Many businesses, schools, and government offices are closed to honor veterans and fallen soldiers.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">Are schools and banks closed on statutory holidays in Saskatchewan?</h3>
                    <p class="text-gray-700 leading-relaxed">Most schools and banks are closed on federal and provincial statutory holidays, including Saskatchewan Day. Always check with your local institution for specific schedules.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">Do all employers have to give paid time off for statutory holidays in Saskatchewan?</h3>
                    <p class="text-gray-700 leading-relaxed">Under The Saskatchewan Employment Act, eligible employees are entitled to statutory holiday pay for designated holidays. Specific rules apply based on employment terms and length of service.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">What happens if a statutory holiday falls on a weekend in Saskatchewan?</h3>
                ...
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">How is Family Day observed in Saskatchewan?</h3>
                    <p class="text-gray-700 leading-relaxed">Family Day (third Monday in February) is a statutory holiday in Saskatchewan, providing a long weekend for families to spend time together during the winter months.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">Is Boxing Day a statutory holiday in Saskatchewan?</h3>
                    <p class="text-gray-700 leading-relaxed">Yes, Boxing Day (December 26) is a statutory holiday in Saskatchewan. If it falls on a weekend, it may be observed on the following Monday depending on employer policies.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">Are there any municipal holidays in Saskatchewan cities?</h3>
                    <p class="text-gray-700 leading-relaxed">Some municipalities may observe additional local holidays or events. Saskatoon and Regina may have specific celebrations, but these are not provincial statutory holidays.</p>
                </div>
                <div class="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-800 mb-3">How do I know if I'm entitled to statutory holiday pay in Saskatchewan?</h3>
                    <p class="text-gray-700 leading-relaxed">Under The Saskatchewan Employment Act, employees who meet certain criteria are entitled to statutory holiday pay. Check with Saskatchewan's Ministry of Labour Relations and Workplace Safety for specific details.</p>
                </div>
            </div>
        </div>
    </section>
