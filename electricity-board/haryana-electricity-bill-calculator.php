...
$slabs = [
    ...
    ['min' => 251, 'max' => 500, 'rate' => 5.50],
    ['min' => 501, 'max' => PHP_FLOAT_MAX, 'rate' => 6.75]
];

// Initialize variables
$discom = $_POST['discom'] ?? 'DHBVN';
...
<body class="bg-gray-50 dark:bg-gray-900 font-sans antialiased">
        ...
        <header class="bg-white dark:bg-gray-800 shadow-sm">
            <div class="container mx-auto px-4 py-6">
                <div class="flex justify-between items-center">
                    <h1 class="text-2xl font-bold text-haryana-600 dark:text-haryana-400">
            ...
            <div class="max-w-4xl mx-auto">
                        ...
                        <div class="p-6 md:p-8 md:w-1/2">
                            ...
                            <form method="post" class="space-y-4">
                                <div>
                                    ...
                                    <select id="discom" name="discom" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-haryana-500 focus:border-transparent transition duration-200">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="number" id="units" name="units" value="<?= $units ?>" min="0" step="1"
                                            class="w-full px-4 py-2.5 pr-12 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-haryana-500 focus:border-transparent transition duration-200"
                                ...
                                <div class="pt-2">
                                    <button type="submit" class="w-full bg-haryana-600 hover:bg-haryana-700 text-white font-medium py-2.5 px-4 rounded-lg shadow-md transition duration-300 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-haryana-500 focus:ring-opacity-50">
                                        Calculate Bill
                                    </button>
                                </div>
                            </form>
                                ...
                                <div class="animate-fade-in">
                                    ...
                                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 mb-6 border border-gray-200 dark:border-gray-600">
                                        <div class="flex justify-between items-center">
                                            ...
                                            <div class="text-3xl font-bold text-haryana-600 dark:text-haryana-400">
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
                    <div class="p-6 md:p-8">
                        ...
                        <div class="space-y-4">
                            <div>
                                <button onclick="toggleFAQ('faq1')" class="flex items-center justify-between w-full text-left font-medium text-haryana-600 hover:text-haryana-800 dark:text-haryana-400 dark:hover:text-haryana-300">
                                    <span>How often are electricity rates updated in Haryana?</span>
                                    <i id="faq1-icon" class="fas fa-chevron-down"></i>
                                </button>
                                <div id="faq1" class="hidden mt-2 text-gray-600 dark:text-gray-400">
                                    <p>Electricity rates in Haryana are typically revised annually by the Haryana Electricity Regulatory Commission (HERC), but may change more frequently based on fuel cost adjustments or policy changes.</p>
                                </div>
                            </div>
                            <div>
                                <button onclick="toggleFAQ('faq2')" class="flex items-center justify-between w-full text-left font-medium text-haryana-600 hover:text-haryana-800 dark:text-haryana-400 dark:hover:text-haryana-300">
                                    <span>What's the difference between DHBVN and UHBVN?</span>
                                    <i id="faq2-icon" class="fas fa-chevron-down"></i>
                                </button>
                                <div id="faq2" class="hidden mt-2 text-gray-600 dark:text-gray-400">
                                    <p>DHBVN (Dakshin Haryana Bijli Vitran Nigam) serves southern Haryana districts, while UHBVN (Uttar Haryana Bijli Vitran Nigam) serves northern districts. Both follow similar tariff structures but may have slight variations in fixed charges.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function shareResult() {
            ...
            if (navigator.share) {
                navigator.share({
                    title: 'Haryana Electricity Bill Calculation',
                    text: text,
                    url: url
                }).catch(err => {
