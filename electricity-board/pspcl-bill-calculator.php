    ...
    <div class="container mx-auto px-4 py-8">
            ...
            <div class="p-6">
                <form method="post" class="space-y-4">
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" id="units" name="units" 
                                   ...
                                   min="0" step="1"
                                   class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-punjab-500 focus:border-transparent"
                    ...
                    <div class="flex gap-3">
                        <button type="submit" 
                                class="flex-1 bg-punjab-600 hover:bg-punjab-700 text-white font-medium py-3 px-4 rounded-lg shadow-md transition duration-300">
                            Calculate Bill
                        </button>
                        <button type="reset" 
                                class="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium py-3 px-4 rounded-lg transition duration-300">
                            Reset
                        </button>
                    </div>
                </form>
                ...
                <?php if ($_SERVER['REQUEST_METHOD'] === 'POST' && $validInput): ?>
                    <div class="mt-6 border-t pt-6">
                        <!-- Result Summary -->
                        <div class="bg-punjab-50 p-4 rounded-lg mb-4">
        ...
        <div class="max-w-md mx-auto mt-8 bg-white rounded-xl shadow-md overflow-hidden">
            <div class="p-6">
                ...
                <p class="text-sm text-gray-500 mt-4">* Rates are subject to change by PSPCL.</p>
            </div>
        </div>
