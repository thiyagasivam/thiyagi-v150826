...
try {
    ...
    // Query the tataservicecenter table
    $stmt = $pdo->prepare("
        SELECT slug, shop_name, address, phone_number
        FROM tataservicecenter
        WHERE slug = ?
    ");
    ...
    $center['email'] = 'customercare@tatamotors.com';
    $center['page_title'] = $center['shop_name'] . ' | Tata Authorized Service Center Near Me 2026';
    $center['about'] = $center['shop_name'] .' is an authorized Tata Motors service center Near Me 2026 providing expert repairs and maintenance for all Tata vehicles.';
...
<title><?= htmlspecialchars($center['page_title'], ENT_QUOTES, 'UTF-8') ?></title>
    ...
    <style>
        :root {
            --primary-color: #4863A0; /* Tata blue */
            --secondary-color: #000000; /* Tata black */
...
<body class="bg-gray-50">
    <header class="bg-gradient-to-r from-blue-900 to-blue-700 text-white py-8">
        <div class="container mx-auto px-4 text-center">
            ...
            <h1 class="text-3xl md:text-4xl font-bold mb-2">
                ...
                <span class="tata-badge">Authorized Tata Service Center Near Me 2026</span>
            </h1>
    ...
    <main class="container mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <section class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="flex items-start mb-4">
                    ...
                    <div>
                        <p class="font-medium">Tata Motor Service Center Address</p>
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-8">
            <h2 class="text-2xl font-semibold text-gray-900 border-b border-gray-200 pb-2 mb-4">About Our Tata Service Center Near Me 2026</h2>
            <div class="prose max-w-none">
                <p class="mb-4"><?= htmlspecialchars($center['about'], ENT_QUOTES, 'UTF-8') ?></p>
                <p>As an authorized Tata Motors service provider, we offer:</p>
                <ul class="list-disc pl-5 mt-2 mb-6">
                    <li>Genuine Tata parts and components</li>
                    <li>Factory-trained technicians</li>
                    <li>Specialized tools for vehicle repairs</li>
                    <li>Warranty and out-of-warranty support</li>
                    <li>Express service for minor repairs</li>
                </ul>
                
                <h3 class="text-xl font-semibold mt-6 mb-3">Tata Vehicles We Service</h3>
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-8">
            <h2 class="text-2xl font-semibold text-gray-900 border-b border-gray-200 pb-2 mb-4">Our Vehicle Services</h2>
            ...
            <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-4 border border-gray-200 rounded-lg bg-blue-50">
                    <h3 class="font-semibold text-gray-800 mb-2"><i class="fas fa-car mr-2"></i> Passenger Vehicles</h3>
                    <p class="text-sm text-gray-600">Comprehensive service for Tata cars, SUVs and other passenger vehicles.</p>
                </div>
                <div class="p-4 border border-gray-200 rounded-lg bg-blue-50">
                    <h3 class="font-semibold text-gray-800 mb-2"><i class="fas fa-truck mr-2"></i> Commercial Vehicles</h3>
                    <p class="text-sm text-gray-600">Specialized service for Tata trucks, buses and commercial vehicles.</p>
                </div>
            </div>
        </section>
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <p class="mb-4">Visit our authorized Tata service center at:</p>
            <div class="flex items-start mb-4">
