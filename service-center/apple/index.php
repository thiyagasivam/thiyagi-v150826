...
// Build query
$sql = "SELECT slug, shop_name, address, phone_number FROM appleservicecenters";
if (!empty($search)) {
...
<meta name="description" content="Find authorized Apple service centers across India. Get contact details, addresses, and phone numbers for genuine Apple repair and support services.">
<title>Apple Authorized Service Centers Near Me 2026</title>
    <style>
        .apple-gradient {
        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <h1 class="text-xl font-bold text-gray-800">Apple Service Centers</h1>
                </div>
    ...
    <div class="apple-gradient">
        <div class="container mx-auto px-4 py-8">
            <div class="max-w-3xl mx-auto text-center">
                <h2 class="text-2xl font-bold text-gray-800 mb-2">Find an Authorized Apple Service Center</h2>
                <p class="text-gray-600 mb-6">Get genuine repairs for your Apple devices by certified technicians</p>
                ...
                <form method="GET" class="mb-6">
                    <div class="relative max-w-xl mx-auto">
                        ...
                        <button 
                            type="submit" 
                            class="absolute right-2 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white px-4 py-1.5 rounded-md text-sm hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500">
                            Search
                        </button>
                    </div>
                </form>
                ...
                <div class="flex flex-wrap justify-center gap-2">
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-white bg-opacity-70 text-gray-800">
                        <i class="fas fa-mobile-screen mr-1"></i> iPhone
                    </span>
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-white bg-opacity-70 text-gray-800">
                        <i class="fas fa-laptop mr-1"></i> MacBook
                    </span>
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-white bg-opacity-70 text-gray-800">
                        <i class="fas fa-tablet-screen-button mr-1"></i> iPad
                    </span>
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-white bg-opacity-70 text-gray-800">
                        <i class="fas fa-clock mr-1"></i> Apple Watch
                    </span>
                </div>
            </div>
        </div>
    ...
    <main class="container mx-auto px-4 py-8">
                ...
                <?php foreach ($serviceCenters as $center): ?>
                    <div class="bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 service-card">
                        ...
                        <div class="bg-gray-50 px-6 py-4 flex justify-between">
                            <a href="/service-center/apple/<?= htmlspecialchars($center['slug']) ?>" class="text-sm font-medium text-gray-700 hover:text-gray-900">
        ...
        <?php else: ?>
            <div class="text-center py-12">
                ...
                <?php if (!empty($search)): ?>
                    <a href="?" class="mt-4 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-gray-800 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
