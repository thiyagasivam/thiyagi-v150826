...
if (empty($slug)) {
    error_log("Canon service center: Empty slug");
    header('HTTP/1.1 301 Moved Permanently');
    header('Location: /service-center/canon/');
    exit;
}
...
try {
    ...
    // Prepare and execute query - changed table name to cannonservicecenter
    $stmt = $pdo->prepare("
        SELECT slug, shop_name, address, phone_number
        FROM cannonservicecenter
        WHERE slug = ?
    ");
    ...
    if (!$center) {
        error_log("Canon service center not found: " . $slug);
        header('HTTP/1.1 301 Moved Permanently');
        header('Location: /service-center/canon/');
        exit;
    }
    ...
    $center['email'] = 'customersupport@canon.co.in';
    $center['page_title'] = $center['shop_name'] . ' | Authorized Canon Service Center Near Me 2026';
    $center['about'] = $center['shop_name'] .' is an authorized Canon service center Near Me 2026 providing expert repairs and support for all Canon cameras, printers, and imaging equipment.';
    
    $center['services'] = [
        'Camera Body Repair',
        'Lens Repair and Calibration',
        'Printer Repair',
        'Sensor Cleaning',
        'Image Stabilization Repair',
        'Viewfinder Repair',
    ...
    error_log("Canon service center DB error: " . $e->getMessage());
    header('HTTP/1.1 301 Moved Permanently');
    header('Location: /service-center/canon/');
    exit;
}
...
<title><?= htmlspecialchars($center['page_title'], ENT_QUOTES, 'UTF-8') ?></title>
    ...
    <style>
        :root {
            --primary-color: #BC002D; /* Canon red */
            --secondary-color: #3C3C3C; /* Canon dark gray */
...
<body class="bg-gray-50">
    <header class="bg-gradient-to-r from-red-800 to-red-600 text-white py-8">
        <div class="container mx-auto px-4 text-center">
            <div class="flex justify-center mb-4">
                <i class="fas fa-camera text-4xl text-red-200"></i>
            </div>
            <h1 class="text-3xl md:text-4xl font-bold mb-2">
                <?= htmlspecialchars($center['shop_name'], ENT_QUOTES, 'UTF-8') ?>
                <span class="canon-badge">Authorized Service Provider</span>
            </h1>
    ...
    <main class="container mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <section class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="flex items-center mb-4">
                    ...
                    <div>
                        <a href="tel:<?= htmlspecialchars(preg_replace('/[^0-9+]/', '', $center['phone_number']), ENT_QUOTES, 'UTF-8') ?>" class="text-gray-800 hover:text-red-600 hover:underline">
                ...
                <div class="flex items-center mb-4">
                    ...
                    <div>
                        <a href="mailto:<?= htmlspecialchars($center['email'], ENT_QUOTES, 'UTF-8') ?>" class="text-gray-800 hover:text-red-600 hover:underline">
                ...
                <div class="flex flex-wrap gap-3 mt-6">
                    ...
                    <a href="tel:<?= htmlspecialchars(preg_replace('/[^0-9+]/', '', $center['phone_number']), ENT_QUOTES, 'UTF-8') ?>" 
                       class="bg-red-700 text-white px-4 py-3 rounded-lg flex items-center">
            ...
            <section class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="mt-4 p-3 bg-red-50 border-l-4 border-red-400">
                    <p class="text-red-700"><i class="fas fa-info-circle mr-2"></i> Appointments recommended for lens calibration</p>
                </div>
            </section>
        </div>

        <section class="bg-white rounded-lg shadow-md p-6 mb-8">
            <h2 class="text-2xl font-semibold text-gray-900 border-b border-gray-200 pb-2 mb-4">About Our Canon Service Center Near Me 2026</h2>
            <div class="prose max-w-none">
                <p class="mb-4"><?= htmlspecialchars($center['about'], ENT_QUOTES, 'UTF-8') ?></p>
                <p>As an authorized Canon service provider, we offer:</p>
                <ul class="list-disc pl-5 mt-2 mb-6">
                    <li>Genuine Canon parts and accessories</li>
                    <li>Canon-certified technicians</li>
                    <li>Precision calibration equipment</li>
                    <li>Warranty and CPS (Canon Professional Services) support</li>
                    <li>Loaner equipment available for pro users</li>
                </ul>
                
                <h3 class="text-xl font-semibold mt-6 mb-3">Canon Products We Service</h3>
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-8">
            <h2 class="text-2xl font-semibold text-gray-900 border-b border-gray-200 pb-2 mb-4">Our Canon Repair Services</h2>
            ...
            <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-4 border border-gray-200 rounded-lg bg-gray-50">
                    <h3 class="font-semibold text-gray-800 mb-2"><i class="fas fa-camera mr-2"></i> Camera Services</h3>
                    <p class="text-sm text-gray-600">Sensor cleaning, shutter replacement, button repair, viewfinder issues, and firmware updates for all Canon cameras.</p>
                </div>
                <div class="p-4 border border-gray-200 rounded-lg bg-gray-50">
                    <h3 class="font-semibold text-gray-800 mb-2"><i class="fas fa-lens mr-2"></i> Lens Services</h3>
                    <p class="text-sm text-gray-600">AF/MF repair, image stabilization, aperture mechanism, zoom ring, and professional cleaning for Canon lenses.</p>
                </div>
            </div>
        </section>
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <p class="mb-4">Visit our authorized Canon service center at:</p>
            <div class="flex items-start mb-4">
            ...
            <div class="mt-4 p-3 bg-gray-50 rounded-lg">
                <p class="text-sm text-gray-600"><i class="fas fa-info-circle mr-2"></i> Free parking available | Professional cleaning station on-site</p>
            </div>
        </section>
        ...
        <section class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <h3 class="text-lg font-medium mb-3"><i class="fas fa-calendar-check mr-2 text-red-600"></i> Book an Appointment</h3>
                ...
                <div>
                    <h3 class="text-lg font-medium mb-3"><i class="fas fa-tools mr-2 text-red-600"></i> Walk-in Repairs</h3>
