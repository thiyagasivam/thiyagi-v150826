...
if (empty($slug)) {
    error_log("TVS service center: Empty slug");
    header('HTTP/1.1 301 Moved Permanently');
    header('Location: /service-center/tvs/');
    exit;
}
...
try {
    ...
    // Query the tvsmotorservicecenter table
    $stmt = $pdo->prepare("
        SELECT slug, shop_name, address, phone_number, maps
        FROM tvsmotorservicecenter
        WHERE slug = ?
    ");
    ...
    if (!$center) {
        error_log("TVS service center not found: " . $slug);
        header('HTTP/1.1 301 Moved Permanently');
        header('Location: /service-center/tvs/');
        exit;
    }
    ...
    $center['email'] = 'customercare@tvsmotor.com';
    $center['page_title'] = $center['shop_name'] . ' | TVS Authorized Service Center Near Me 2026';
    $center['about'] = $center['shop_name'] .' is an authorized TVS Motor service center Near Me 2026 providing expert repairs and maintenance for all TVS two-wheelers.';
...
<title><?= htmlspecialchars($center['page_title'], ENT_QUOTES, 'UTF-8') ?></title>
    ...
    <style>
        :root {
            --primary-color: #E11B22; /* TVS red */
            --secondary-color: #000000; /* TVS black */
...
<body class="bg-gray-50">
    <header class="bg-gradient-to-r from-red-900 to-red-700 text-white py-8">
        <div class="container mx-auto px-4 text-center">
            <div class="flex justify-center mb-4">
                <i class="fas fa-motorcycle text-4xl text-red-200"></i>
            </div>
            <h1 class="text-3xl md:text-4xl font-bold mb-2">
                <?= htmlspecialchars($center['shop_name'], ENT_QUOTES, 'UTF-8') ?>
                <span class="tvs-badge">Authorized Service Center</span>
            </h1>
    ...
    <main class="container mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <section class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="mt-4 p-3 bg-red-50 border-l-4 border-red-400">
                    <p class="text-red-700"><i class="fas fa-info-circle mr-2"></i> Appointments recommended for major repairs</p>
                </div>
            </section>
        </div>

        <section class="bg-white rounded-lg shadow-md p-6 mb-8">
            <h2 class="text-2xl font-semibold text-gray-900 border-b border-gray-200 pb-2 mb-4">About Our TVS Service Center Near Me 2026</h2>
            <div class="prose max-w-none">
                <p class="mb-4"><?= htmlspecialchars($center['about'], ENT_QUOTES, 'UTF-8') ?></p>
                <p>As an authorized TVS Motor service provider, we offer:</p>
                <ul class="list-disc pl-5 mt-2 mb-6">
                    <li>Genuine TVS parts and components</li>
                ...
                <h3 class="text-xl font-semibold mt-6 mb-3">TVS Models We Service</h3>
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-4 border border-gray-200 rounded-lg bg-red-50">
                    ...
                    <p class="text-sm text-gray-600">Comprehensive service for TVS Apache, RTR and other motorcycles.</p>
                </div>
                <div class="p-4 border border-gray-200 rounded-lg bg-red-50">
                    <h3 class="font-semibold text-gray-800 mb-2"><i class="fas fa-scooter mr-2"></i> Scooters</h3>
                    <p class="text-sm text-gray-600">Specialized service for TVS Jupiter, Ntorq and other scooters.</p>
                </div>
            </div>
        </section>
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <p class="mb-4">Visit our authorized TVS service center at:</p>
            <div class="flex items-start mb-4">
        ...
        <section class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <h3 class="text-lg font-medium mb-3"><i class="fas fa-tools mr-2 text-red-600"></i> Walk-in Services</h3>
