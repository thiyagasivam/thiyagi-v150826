...
if (empty($slug)) {
    error_log("Crompton service center: Empty slug");
    header('HTTP/1.1 301 Moved Permanently');
    header('Location: /service-center/crompton/');
    exit;
}
...
try {
    ...
    // Query the cromptonservicecenter table
    $stmt = $pdo->prepare("
        SELECT slug, shop_name, address, phone_number
        FROM cromptonservicecenter
        WHERE slug = ?
    ");
    ...
    if (!$center) {
        error_log("Crompton service center not found: " . $slug);
        header('HTTP/1.1 301 Moved Permanently');
        header('Location: /service-center/crompton/');
        exit;
    }
...
<title><?= htmlspecialchars($center['page_title'], ENT_QUOTES, 'UTF-8') ?></title>
    ...
    <style>
        :root {
            --primary-color: #0066CC; /* Crompton blue */
...
<body class="bg-gray-50">
    <header class="bg-gradient-to-r from-blue-800 to-blue-600 text-white py-8">
        <div class="container mx-auto px-4 text-center">
            <div class="flex justify-center mb-4">
                <i class="fas fa-fan text-4xl text-blue-200"></i>
            </div>
            <h1 class="text-3xl md:text-4xl font-bold mb-2">
                <?= htmlspecialchars($center['shop_name'], ENT_QUOTES, 'UTF-8') ?>
                <span class="crompton-badge">Authorized Service Center</span>
            </h1>
    ...
    <main class="container mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <section class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="mt-4 p-3 bg-blue-50 border-l-4 border-blue-400">
                    <p class="text-blue-700"><i class="fas fa-info-circle mr-2"></i> Appointments recommended for motor rewinding services</p>
                </div>
            </section>
        </div>

        <section class="bg-white rounded-lg shadow-md p-6 mb-8">
            <h2 class="text-2xl font-semibold text-gray-900 border-b border-gray-200 pb-2 mb-4">About Our Crompton Service Center Near Me</h2>
            <div class="prose max-w-none">
                <p class="mb-4"><?= htmlspecialchars($center['about'], ENT_QUOTES, 'UTF-8') ?></p>
                <p>As an authorized Crompton service provider, we offer:</p>
                <ul class="list-disc pl-5 mt-2 mb-6">
                    <li>Genuine Crompton parts and components</li>
                    <li>Factory-trained technicians</li>
                    <li>Specialized tools for fan repairs</li>
                    <li>Warranty and out-of-warranty support</li>
                    <li>Same-day service for most repairs</li>
                </ul>
                
                <h3 class="text-xl font-semibold mt-6 mb-3">Crompton Products We Service</h3>
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-8">
            <h2 class="text-2xl font-semibold text-gray-900 border-b border-gray-200 pb-2 mb-4">Our Crompton Repair Services</h2>
            ...
            <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-4 border border-gray-200 rounded-lg bg-gray-50">
                    ...
                    <p class="text-sm text-gray-600">Fan repair, motor servicing, capacitor replacement, speed control issues for all Crompton ceiling fans, table fans, and exhaust fans.</p>
                </div>
                <div class="p-4 border border-gray-200 rounded-lg bg-gray-50">
                    <h3 class="font-semibold text-gray-800 mb-2"><i class="fas fa-lightbulb mr-2"></i> Lighting Services</h3>
                    <p class="text-sm text-gray-600">LED light repair, wiring issues, switch replacement, and electrical troubleshooting for Crompton lighting products.</p>
                </div>
            </div>
        </section>
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <p class="mb-4">Visit our authorized Crompton service center at:</p>
            <div class="flex items-start mb-4">
            ...
            <div class="mt-4 p-3 bg-gray-50 rounded-lg">
                <p class="text-sm text-gray-600"><i class="fas fa-info-circle mr-2"></i> Free parking available | Same-day service for most fan repairs</p>
            </div>
        </section>
