...
$breadcrumbSchema = [
    ...
    "itemListElement" => [
        ...
        [
            "@type" => "ListItem",
            "position" => 3,
            "name" => "Poco Service Centers",
            "item" => "https://www.thiyagi.com/service-center/poco/"
        ],
        [
            "@type" => "ListItem",
            "position" => 4,
                "name" => (isset($center) && $center && isset($center['shop_name']) ? $center['shop_name'] . " - Poco Authorized Service Center" : "Poco Authorized Service Center"),
                "item" => $currentUrl
        ]
    ]
];
...
if (empty($slug)) {
    error_log("Poco service center: Empty slug");
    header('HTTP/1.1 301 Moved Permanently');
    header('Location: /service-center/poco/');
    exit;
}
...
try {
    ...
    // Query the pocoservicecenter table
    $stmt = $pdo->prepare("
        SELECT slug, shop_name, address, phone_number
        FROM pocoservicecenter
        WHERE slug = ?
    ");
    ...
    if (!$center) {
        error_log("Poco service center not found: " . $slug);
        header('HTTP/1.1 301 Moved Permanently');
        header('Location: /service-center/poco/');
        exit;
    }
    ...
    $center['email'] = 'support@poco.com';
    $center['page_title'] = $center['shop_name'] . ' | Poco Authorized Service Center Near Me 2026';
    $center['about'] = $center['shop_name'] .' is an authorized Poco service center Near Me 2026 providing expert repairs and maintenance for all Poco smartphones and devices.';
...
<title><?= htmlspecialchars($center['page_title'], ENT_QUOTES, 'UTF-8') ?></title>
    ...
    <style>
        :root {
            --primary-color: #FF6900; /* Poco orange */
            --secondary-color: #000000; /* Poco black */
...
<body class="bg-gray-50">
    <header class="bg-gradient-to-r from-orange-600 to-orange-400 text-white py-8">
        <div class="container mx-auto px-4 text-center">
            <div class="flex justify-center mb-4">
                <i class="fas fa-mobile-alt text-4xl text-orange-200"></i>
            </div>
            <h1 class="text-3xl md:text-4xl font-bold mb-2">
                <?= htmlspecialchars($center['shop_name'], ENT_QUOTES, 'UTF-8') ?>
                <span class="poco-badge">Authorized Service Center</span>
            </h1>
    ...
    <main class="container mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <section class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="flex items-center mb-4">
                    ...
                    <div>
                        <a href="tel:<?= htmlspecialchars(preg_replace('/[^0-9+]/', '', $center['phone_number']), ENT_QUOTES, 'UTF-8') ?>" class="text-gray-800 hover:text-orange-600 hover:underline">
                ...
                <div class="flex items-center mb-4">
                    ...
                    <div>
                        <a href="mailto:<?= htmlspecialchars($center['email'], ENT_QUOTES, 'UTF-8') ?>" class="text-gray-800 hover:text-orange-600 hover:underline">
                ...
                <div class="flex flex-wrap gap-3 mt-6">
                    ...
                    <a href="tel:<?= htmlspecialchars(preg_replace('/[^0-9+]/', '', $center['phone_number']), ENT_QUOTES, 'UTF-8') ?>" 
                       class="bg-orange-600 text-white px-4 py-3 rounded-lg flex items-center">
            ...
            <section class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="mt-4 p-3 bg-orange-50 border-l-4 border-orange-400">
                    <p class="text-orange-700"><i class="fas fa-info-circle mr-2"></i> Appointments recommended for hardware repairs</p>
                </div>
            </section>
        </div>

        <section class="bg-white rounded-lg shadow-md p-6 mb-8">
            <h2 class="text-2xl font-semibold text-gray-900 border-b border-gray-200 pb-2 mb-4">About Our Poco Service Center Near Me 2026</h2>
            <div class="prose max-w-none">
                <p class="mb-4"><?= htmlspecialchars($center['about'], ENT_QUOTES, 'UTF-8') ?></p>
                <p>As an authorized Poco service provider, we offer:</p>
                <ul class="list-disc pl-5 mt-2 mb-6">
                    <li>Genuine Poco parts and components</li>
                ...
                <h3 class="text-xl font-semibold mt-6 mb-3">Poco Products We Service</h3>
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-8">
            <h2 class="text-2xl font-semibold text-gray-900 border-b border-gray-200 pb-2 mb-4">Our Poco Repair Services</h2>
            ...
            <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="p-4 border border-gray-200 rounded-lg bg-orange-50">
                    ...
                    <p class="text-sm text-gray-600">MIUI updates, software troubleshooting, and performance optimization for Poco devices.</p>
                </div>
            </div>
        </section>
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <p class="mb-4">Visit our authorized Poco service center at:</p>
            <div class="flex items-start mb-4">
                <i class="fas fa-map-marker-alt text-orange-500 mt-1 mr-3 text-xl"></i>
                <div>
        ...
        <section class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <h3 class="text-lg font-medium mb-3"><i class="fas fa-calendar-check mr-2 text-orange-600"></i> Book an Appointment</h3>
                    <p class="text-gray-600 mb-4">Schedule your service in advance to minimize wait time.</p>
                    <a href="tel:<?= htmlspecialchars(preg_replace('/[^0-9+]/', '', $center['phone_number']), ENT_QUOTES, 'UTF-8') ?>" 
                       class="inline-block bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded-lg">
                        <i class="fas fa-phone mr-2"></i> Call to Book
                    </a>
                </div>
                <div>
                    <h3 class="text-lg font-medium mb-3"><i class="fas fa-tools mr-2 text-orange-600"></i> Walk-in Services</h3>
    ...
    <style>
        ...
        .modern-heading::after {
            ...
            width: 80px;
            height: 5px;
            background: linear-gradient(90deg, #FF6900, #E55D00);
