...
if (empty($slug)) {
    error_log("Godrej service center: Empty slug");
    header('HTTP/1.1 301 Moved Permanently');
    header('Location: /service-center/godrej/');
    exit;
}
...
try {
    ...
    // Prepare and execute query for Godrej service centers
    $stmt = $pdo->prepare("
        SELECT slug, shop_name, address, phone_number
        FROM godrejservicecenter
        WHERE slug = ?
    ");
    ...
    if (!$center) {
        error_log("Godrej service center not found: " . $slug);
        header('HTTP/1.1 301 Moved Permanently');
        header('Location: /service-center/godrej/');
        exit;
    }
    ...
    $center['email'] = 'info@godrej.com';
    $center['page_title'] = $center['shop_name'] . ' | Authorized Godrej Service Center Near Me 2026';
    $center['about'] = $center['shop_name'] .' is an authorized Godrej service center Near Me 2026 providing expert repairs and maintenance for all Godrej products including fans, air conditioners, appliances and more.';
    ...
    $center['brands_serviced'] = [
        ...
        'Godrej Water Heaters',
        'Godrej Air Coolers',
        'Godrej Electrical Appliances'
    ];
...
<title><?= htmlspecialchars($center['page_title'], ENT_QUOTES, 'UTF-8') ?></title>
    ...
    <style>
        :root {
            --primary-color: #004B87; /* Godrej blue */
            --secondary-color: #FF6A00; /* Godrej orange */
            --accent-color: #004B87;
            --light-color: #f5f5f7;
...
<body class="bg-gray-50">
    <header class="bg-gradient-to-r from-blue-900 to-blue-700 text-white py-8">
        <div class="container mx-auto px-4 text-center">
            ...
            <h1 class="text-3xl md:text-4xl font-bold mb-2">
                ...
                <span class="godrej-badge">Authorized Service Provider</span>
            </h1>
    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-8">
            <h2 class="text-2xl font-semibold text-gray-900 border-b border-gray-200 pb-2 mb-4">About Our Godrej Service Center Near Me 2026</h2>
            <div class="prose max-w-none">
                <p class="mb-4"><?= htmlspecialchars($center['about'], ENT_QUOTES, 'UTF-8') ?></p>
                <p>As an authorized Godrej service provider, we offer:</p>
                <ul class="list-disc pl-5 mt-2 mb-6">
                    <li>Genuine Godrej parts and components</li>
                ...
                <h3 class="text-xl font-semibold mt-6 mb-3">Godrej Products We Service</h3>
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-8">
            <h2 class="text-2xl font-semibold text-gray-900 border-b border-gray-200 pb-2 mb-4">Our Godrej Repair Services</h2>
            ...
            <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-4 border border-gray-200 rounded-lg bg-gray-50">
                    <h3 class="font-semibold text-gray-800 mb-2"><i class="fas fa-fan mr-2"></i> Fan Services</h3>
                    <p class="text-sm text-gray-600">Motor repair, capacitor replacement, speed control issues, blade balancing, and more for all Godrej ceiling fans, table fans, and exhaust fans.</p>
                </div>
                <div class="p-4 border border-gray-200 rounded-lg bg-gray-50">
                    <h3 class="font-semibold text-gray-800 mb-2"><i class="fas fa-wind mr-2"></i> AC Services</h3>
                    <p class="text-sm text-gray-600">Gas refilling, compressor repair, thermostat issues, cooling problems, and regular maintenance for Godrej air conditioners.</p>
                </div>
            </div>
        </section>
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <p class="mb-4">Visit our authorized Godrej service center at:</p>
            <div class="flex items-start mb-4">
