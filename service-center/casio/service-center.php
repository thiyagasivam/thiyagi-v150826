...
if (empty($slug)) {
    error_log("Casio service center: Empty slug");
    header('HTTP/1.1 301 Moved Permanently');
    header('Location: /service-center/casio/');
    exit;
}
...
try {
    ...
    // Prepare and execute query - changed table name to casioservicecenter
    $stmt = $pdo->prepare("
        SELECT slug, shop_name, address, phone_number
        FROM casioservicecenter
        WHERE slug = ?
    ");
    ...
    if (!$center) {
        error_log("Casio service center not found: " . $slug);
        header('HTTP/1.1 301 Moved Permanently');
        header('Location: /service-center/casio/');
        exit;
    }
    ...
    $center['email'] = 'casiocare@casio.co.in';
    $center['page_title'] = $center['shop_name'] . ' | Authorized Casio Service Center Near Me 2026';
    $center['about'] = $center['shop_name'] .' is an authorized Casio service center Near Me 2026 providing expert repairs and support for all Casio watches, calculators, and electronic devices.';
    ...
    $center['brands_serviced'] = [
        'Casio Watches (G-Shock, Edifice, etc.)',
        'Casio Calculators',
        'Casio Keyboards',
...
<title><?= htmlspecialchars($center['page_title'], ENT_QUOTES, 'UTF-8') ?></title>
    ...
    <style>
        :root {
            --primary-color: #D40000; /* Casio red */
            --secondary-color: #000000; /* Casio black */
...
<body class="bg-gray-50">
    <header class="bg-gradient-to-r from-red-800 to-red-600 text-white py-8">
        <div class="container mx-auto px-4 text-center">
            ...
            <h1 class="text-3xl md:text-4xl font-bold mb-2">
                ...
                <span class="casio-badge">Authorized Service Provider</span>
            </h1>
    ...
    <main class="container mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <section class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="mt-4 p-3 bg-red-50 border-l-4 border-red-400">
                    <p class="text-red-700"><i class="fas fa-info-circle mr-2"></i> Appointments recommended for watch repairs</p>
                </div>
            </section>
        </div>

        <section class="bg-white rounded-lg shadow-md p-6 mb-8">
            <h2 class="text-2xl font-semibold text-gray-900 border-b border-gray-200 pb-2 mb-4">About Our Casio Service Center Near Me 2026</h2>
            <div class="prose max-w-none">
                <p class="mb-4"><?= htmlspecialchars($center['about'], ENT_QUOTES, 'UTF-8') ?></p>
                <p>As an authorized Casio service provider, we offer:</p>
                <ul class="list-disc pl-5 mt-2 mb-6">
                    <li>Genuine Casio parts and batteries</li>
                    <li>Factory-trained technicians</li>
                    <li>Specialized tools for watch repairs</li>
                    <li>Warranty and out-of-warranty support</li>
                    <li>Quick turnaround for most repairs</li>
                </ul>
                
                <h3 class="text-xl font-semibold mt-6 mb-3">Casio Products We Service</h3>
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-8">
            <h2 class="text-2xl font-semibold text-gray-900 border-b border-gray-200 pb-2 mb-4">Our Casio Repair Services</h2>
            ...
            <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-4 border border-gray-200 rounded-lg bg-gray-50">
                    <h3 class="font-semibold text-gray-800 mb-2"><i class="fas fa-clock mr-2"></i> Watch Services</h3>
                    <p class="text-sm text-gray-600">Battery replacement, water resistance testing, band replacement, movement repair for all Casio watches including G-Shock.</p>
                </div>
                <div class="p-4 border border-gray-200 rounded-lg bg-gray-50">
                    <h3 class="font-semibold text-gray-800 mb-2"><i class="fas fa-calculator mr-2"></i> Calculator Services</h3>
                    <p class="text-sm text-gray-600">Button repair, display replacement, circuit board repair, and battery compartment issues for Casio calculators.</p>
                </div>
            </div>
        </section>
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <p class="mb-4">Visit our authorized Casio service center at:</p>
            <div class="flex items-start mb-4">
            ...
            <div class="mt-4 p-3 bg-gray-50 rounded-lg">
                <p class="text-sm text-gray-600"><i class="fas fa-info-circle mr-2"></i> Free parking available | Watch battery replacement while you wait</p>
            </div>
        </section>
